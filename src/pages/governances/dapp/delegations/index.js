...
const DelegationsList = ({ mine, onList }) => {
  ...
  <ul className={style.SectionSubMenuItems}>
      ...
      <li className={style.SectionSubMenuItemsActive}><Link to="/organizations/delegations">Delegations</Link></li>
    </ul>
    <div className={style.ItemsExploreMainTitleArea}>
      <h2>Delegations list
        <Link to="/organizations/create/delegation" className={style.ItemsExploreMainCategoriesCreateElement} style={{'marginTop': '10px'}}>
      ...
      <div className={style.ItemsExploreMainSearch} style={{'marginRight': '140px'}}>
