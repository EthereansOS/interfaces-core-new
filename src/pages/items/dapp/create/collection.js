    ...
    return (<>
       <div className={style.FancyExplanationCreate}>
        ...
        {state.metadataType === 'metadata' && <>
            ...
            <MetadataField state={state} onStateEntry={onStateEntry} accept='.png,.gif,.jpeg,.jpg' field='image' label='Logo' mandatory description='A valid IPFS link for your logo. Please upload a square picture (.png, .gif or .jpg, max size 1mb) so that it fits perfectly with the EthereansOS interface style.'/>
