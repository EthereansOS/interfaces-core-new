...
const DecksList = ({}) => (<div className={style.SectionMinWidth}>
  ...
  <ul className={style.SectionSubMenuItems}>
      ...
      <li className={style.SectionSubMenuItemsActive}><Link to="/items/decks">Decks</Link></li>
    ...
    <div className={style.ItemsExploreMainTitleArea}>
      <h2>What's trending now in Decks</h2>
