...
const Collections = () => (<div className={style.SectionMinWidth}>
  ...
  <ul className={style.SectionSubMenuItems}>
      ...
      <li className={style.SectionSubMenuItemsActive}><Link to="/items/collections"><a href="#">Collections</a></Link></li>
