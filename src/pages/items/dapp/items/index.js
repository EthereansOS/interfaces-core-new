...
const ItemsList = ({wrappedOnly}) => (<div className={style.SectionMinWidth}>
    ...
    <ul className={style.SectionSubMenuItems}>
      <li className={style.SectionSubMenuItemsActive}><Link to="/items">Items</Link></li>
      <li><Link to="/items/decks">Decks</Link></li>
      <li><Link to="/items/collections"><a href="#">Collections</a></Link></li>
      <li><Link to="/items/wrap"><a href="#">Wrap</a></Link></li>
    </ul>
    <div className={style.ItemsExploreMainTitleArea}>
      <h2>What's trending now</h2>
      <p>Discover the most trending NFT's in EthereanOS.</p>
