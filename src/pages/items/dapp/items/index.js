...
const ItemsList = ({wrappedOnly}) => (<>
    ...
    <ul className={style.SectionSubMenuItems}>
      <li className={style.SectionSubMenuItemsActive}><a href="#">Items</a></li>
      <li><Link to="/items/decks">Decks</Link></li>
      <li><Link to="/items/decks"><a href="#">Collections</a></Link></li>
      <li><Link to="/items/decks"><a href="#">Wrap</a></Link></li>
    </ul>
