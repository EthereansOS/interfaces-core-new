...
const ExploreOrganization = ({ address, type }) => {
  ...
  return (
    ...
    <Link
      ...
      to={`/organizations/${type ? type + '/' : ''}${address}`}>
      {element ? (
        <>
        <button className={style.ItemTitleTopZoneLikeButton}><svg  viewBox="0 0 24 24" fill="none"><path d="M12.62 20.81C12.28 20.93 11.72 20.93 11.38 20.81C8.48 19.82 2 15.69 2 8.68998C2 5.59998 4.49 3.09998 7.56 3.09998C9.38 3.09998 10.99 3.97998 12 5.33998C13.01 3.97998 14.63 3.09998 16.44 3.09998C19.51 3.09998 22 5.59998 22 8.68998C22 15.69 15.52 19.82 12.62 20.81Z" stroke="currentColor" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg></button>
        ...
        {type === 'delegations' ? (
            <>
              <p className={style.ItemTitleTopZoneLabel}>Supporters stake</p>
              <p className={style.ItemTitleTopZoneValue}>3,684.8533 OS</p>
            </>
          ) : (
            <>
              <p className={style.ItemTitleTopZoneLabel}>Treasury Balance</p>
        ...
        <svg className={style.ItemTitleBottomZone} width="281" viewBox="0 0 281 99" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0V99H258.059C248.54 99 239.92 93.3743 236.089 84.6606L205.167 14.3394C201.335 5.62568 192.716 0 183.197 0H0Z" fill="currentColor"></path></svg>
