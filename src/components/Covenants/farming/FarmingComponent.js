...
export default props => {
    ...
    const dailyReward = useMemo(() => numberToString(element.rewardPerBlock).ethereansosMul(6400), [element && element.rewardPerBlock])
            ...
            <div className={style.FarmContentInfo}>
                {element.setups.filter(it => it.active || it.canActivateSetup) === 0 ? <>
                    ...
                    <p>
                        ...
                        {setOpened && <a className={style.CopyBTN} onClick={() => copyToClipboard(`${window.location.href}/${element.address}`)}>
                        <svg preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" width="48" height="48" id="copy"><path fill="none" d="M0 0h48v48H0z"></path><path d="M32 2H8C5.79 2 4 3.79 4 6v28h4V6h24V2zm6 8H16c-2.21 0-4 1.79-4 4v28c0 2.21 1.79 4 4 4h22c2.21 0 4-1.79 4-4V14c0-2.21-1.79-4-4-4zm0 32H16V14h22v28z"></path></svg>
                        </a>}
                    </p>
                </>}
                <div>
