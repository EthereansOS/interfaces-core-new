    ...
    return (
        <div onClick={close} className={style.ModalBack}>
            <div onClick={preventClose} className={style.ModalBoxBanner}>
                <h5><b>The EthereansOS interface is in its BETA Version, and has limited features.</b></h5>
                <h6>If you find any issues, please contact us <a target="_blank" href={context.discordLink}>in our Discord Server</a>.</h6>
