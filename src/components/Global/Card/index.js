...
function Card({ ensData, chainId, account, triggerConnect }) {
    useEffect(() => {
        const tl = gsap.timeline()
            ...
            .from('svg image', { x: -40, duration: 1.1, ease: 'expo.inOut', stagger: 0.2 }, 1)
            ...
            .fromTo('#wave2', { x: 0, y: 0 }, { duration: 6, x: 804, y: -917, repeat: -1, ease: 'none' }, 0);

        let starShine = gsap.timeline()
    ...
    return (
        <div>
            <svg class="profileArea" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 600 368">
                <defs>
                    <mask id="chipMask">
                ...
                <g mask="url(#cardMask)">
                    ...
                    <g fill="none" stroke="#555" strokeWidth="40" strokeDasharray="6 2 4 2.5 4 3 3.5 3">
                    ...
                    <g fill="#fff" strokeLinecap="round">
                        <g clipPath="url(#txtBoxes)">
                            ...
                            <text x="45" y="260" fontSize="16">{ensData?.name ? `${ensData.name}` : '-'}</text>
                            <text x="45" y="290" fontSize="19" fontWeight='bold'>Address</text>
                            <text x="45" y="320" fontSize="16">
                                <a href={`${getNetworkElement({ context, chainId }, 'etherscanURL')}address/${account}`} target="_blank">{account}</a></text>
                        </g>
                       
                        <rect mask="url(#chipMask)" rx="5" ry="5" x="89" y="125" width="250" height="100" />
                    </g>
                </g>
            </svg>
