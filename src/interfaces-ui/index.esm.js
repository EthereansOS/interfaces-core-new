...
var sizePropType = T$1.oneOf(['small', 'medium', 'large'])
...
Button.propTypes = {
  className: T$1.string,
  text: T$1.string.isRequired,
  type: T$1.oneOf(['submit', 'button']),
  fullWidth: T$1.bool,
  color: T$1.oneOf(['primary', 'secondary', 'tertiary']),
  size: sizePropType,
}
Button.defaultProps = {
  color: 'primary',
...
Card.propTypes = {
  footerClassName: T$1.string,
  headerClassName: T$1.string,
  children: T$1.node,
  Footer: T$1.node,
  Header: T$1.node,
  className: T$1.string,
  contentClassName: T$1.string,
}
...
Container.propTypes = {
  className: T$1.string,
  children: T$1.oneOfType([T$1.arrayOf(T$1.node), T$1.node]),
}
...
Typography.propTypes = {
  className: T$1.string,
  align: T$1.oneOf(['left', 'center', 'right']),
  children: T$1.oneOfType([T$1.arrayOf(T$1.node), T$1.node]),
  variant: T$1.oneOf([
    'h1',
    'h2',
  ...
  color: T$1.string,
  fontFamily: T$1.string,
  weight: T$1.oneOfType([T$1.string, T$1.number]),
  as: T$1.string,
}
          ...
          cols.map(function (c) {
            return /*#__PURE__*/ React.createElement(
              ...
              c.renderCell && r[c.field]
                ? /*#__PURE__*/ React.createElement(c.renderCell, {
                    row: r,
                    value: r[c.field],
                  })
                : /*#__PURE__*/ React.createElement(
...
Table.propTypes = {
  tableClassName: T$1.string,
  rows: T$1.arrayOf(
    T$1.shape({
      id: T$1.oneOfType([T$1.string, T$1.number]),
    })
  ).isRequired,
  columns: T$1.arrayOf(
    T$1.shape({
      field: T$1.string,
      headerName: T$1.string,
      renderCell: T$1.func,
      flex: T$1.number,
    })
  ).isRequired,
...
TextField.propTypes = {
  className: T$1.string,
  isMultiline: T$1.bool,
  isRounded: T$1.bool,
  onChange: T$1.func.isRequired,
  startComponent: T$1.node,
  endComponent: T$1.node,
  inputClassName: T$1.string,
}
...
var AutosizeInput_1 = createCommonjsModule(function (module, exports) {
  ...
  var _propTypes2 = _interopRequireDefault(T$1)
...
Select.propTypes = {
  containerClassName: T$1.string,
  selectClassName: T$1.string,
  id: T$1.string.isRequired,
  onSelect: T$1.func.isRequired,
  options: T$1.arrayOf(T$1.object).isRequired,
  value: T$1.any.isRequired,
  showIcon: T$1.bool,
}
...
SnackBar.propTypes = {
  timeout: T$1.number,
  setContent: T$1.func.isRequired,
  content: T$1.shape({
    type: T$1.oneOf(['error', 'warning', 'success']),
    message: T$1.string,
  }),
}
...
var ConnectWidget = function ConnectWidget(_ref) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    connectionStatus === web3States.CONNECTED &&
      /*#__PURE__*/ React.createElement('div', null, 'Connected'),
    connectionStatus === web3States.CONNECTING &&
      /*#__PURE__*/ React.createElement('div', null, 'Connecting'),
...
ConnectWidget.propTypes = {
  logo: T$1.string,
  onClickConnect: T$1.func,
  connectionStatus: T$1.string.isRequired,
  title: T$1.string,
  className: T$1.string,
  connectError: T$1.string,
  rotateLogo: T$1.bool,
  wallet: T$1.shape({
    networkName: T$1.string,
    connect: T$1.func.isRequired,
    status: T$1.oneOf(['disconnected', 'connecting', 'connected', 'error'])
      .isRequired,
    error: T$1.shape({
      name: T$1.string,
      message: T$1.string,
    }),
    reset: T$1.func.isRequired,
  }).isRequired,
  connectors: T$1.arrayOf(
    T$1.shape({
      id: T$1.string,
      buttonText: T$1.string,
    })
  ),
}
...
function Field(_ref) {
  ...
  return createElement(asElement, _extends$e({}, field, props), children)
}
...
var TokenPicker = function TokenPicker(_ref) {
  ...
  var uniswapPairs = useLoadUniswapPairs(tokenAddress)
  var options = useMemo(
    function () {
...
EditField.propTypes = {
  ...
  name: T$1.string,
  label: T$1.string,
  description: T$1.string,
  RightInputComponent: T$1.node,
}
      ...
      function (_ref2) {
        ...
        return /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(EditField, {
            ...
            min: '0',
            step: 0.000000001,
            RightInputComponent: /*#__PURE__*/ React.createElement(Token, {
              symbol: token.symbol,
            }),
          }),
          /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(TokenPicker, {
            id: 'token',
            name: 'token',
            tokenAddress:
...
Swap.propTypes = {
  onSwap: T$1.func.isRequired,
  token: T$1.object.isRequired,
  organization: T$1.object,
  onSwapSubmit: T$1.func,
}
...
Transfer.propTypes = {
  onTransferSubmit: T$1.func.isRequired,
  token: T$1.object.isRequired,
}
...
Balance.propTypes = {
  className: T$1.string,
  showActions: T$1.bool,
  token: T$1.shape({
    symbol: T$1.string,
    logo: T$1.string,
  }).isRequired,
  tokenPrice: T$1.oneOfType([T$1.string, T$1.number]),
  tokenAmount: T$1.string,
  onSwapSubmit: T$1.func,
  onTransferSubmit: T$1.func,
}
...
Raised.propTypes = {
  background: T$1.string,
  zDepth: T$1.oneOf([0, 1, 2, 3, 4, 5]),
  radius: T$1.number,
  styles: T$1.object,
}
...
Block.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  colors: T$1.arrayOf(T$1.string),
  triangle: T$1.oneOf(['top', 'hide']),
  styles: T$1.object,
}
...
Circle.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  circleSize: T$1.number,
  circleSpacing: T$1.number,
  styles: T$1.object,
}
...
Chrome.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  disableAlpha: T$1.bool,
  styles: T$1.object,
  defaultView: T$1.oneOf(['hex', 'rgb', 'hsl']),
}
...
var PhotoshopPicker = function PhotoshopPicker(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('div', { style: styles.symbol }, '\xB0'),
...
var PhotoshopPreviews = function PhotoshopPreviews(_ref) {
  ...
  return React.createElement(
    'div',
    null,
    React.createElement('div', { style: styles.label }, 'new'),
    React.createElement(
      'div',
      { style: styles.swatches },
    ...
    React.createElement('div', { style: styles.label }, 'current')
  )
}
  ...
  _createClass(Photoshop, [
    {
      ...
      value: function render() {
        ...
        return React.createElement(
          ...
          React.createElement('div', { style: styles.head }, this.props.header),
          React.createElement(
            'div',
...
Swatches.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  height: T$1.oneOfType([T$1.string, T$1.number]),
  colors: T$1.arrayOf(T$1.arrayOf(T$1.string)),
  styles: T$1.object,
...
var Twitter = function Twitter(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('div', { style: styles.hash }, '#'),
      React.createElement(EditableInput, {
        label: null,
        style: { input: styles.input },
        value: hex.replace('#', ''),
...
Twitter.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  triangle: T$1.oneOf(['hide', 'top-left', 'top-right']),
  colors: T$1.arrayOf(T$1.string),
  styles: T$1.object,
}
...
var Google = function Google(_ref) {
  ...
  return React.createElement(
    ...
    React.createElement('div', { style: styles.head }, header),
...
var ColorField = function ColorField(_ref) {
  ...
  var handleChangeColor = useCallback(
  ...
  var handleChangeComplete = useCallback(
    function (color, event) {
      helpers.setValue(color.hex)
      event.stopPropagation()
      event.preventDefault()
