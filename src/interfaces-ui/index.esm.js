import React, { useContext, createElement, Fragment as Fragment$1, createContext, forwardRef, useRef, useLayoutEffect, Component, useMemo, useCallback, useEffect, useState, Children, useReducer, useImperativeHandle, isValidElement, PureComponent } from 'react';
import T$1 from 'prop-types';
import { web3States, useLoadUniswapPairs, useWeb3, VOID_ETHEREUM_ADDRESS } from 'interfaces-core';
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React.createElement("button", _extends$g({}, props, {
...
var Typography = function Typography(props) {
  ...
  return /*#__PURE__*/React.createElement(as || variantToTags[variant] || variant, _objectSpread2$1(_objectSpread2$1({}, attr), {}, {
    children: children
  }));
};
...
Typography.propTypes = {
  ...
  children: T$1.oneOfType([T$1.arrayOf(T$1.node), T$1.node]),
  variant: T$1.oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'h7', 'body1', 'body2', 'subtitle1', 'subtitle2']),
  color: T$1.string,
...
var Link = function Link(_ref) {
  ...
  if (to) {
    return /*#__PURE__*/React.createElement(RLink, _extends$g({
      to: to
    }, props, {
...
function Table(_ref) {
  ...
  return /*#__PURE__*/React.createElement("table", {
    ...
    return /*#__PURE__*/React.createElement("tr", {
      ...
      }, c.renderCell && r[c.field] ? /*#__PURE__*/React.createElement(c.renderCell, {
        row: r,
        value: r[c.field]
      }) : /*#__PURE__*/React.createElement(Typography, {
        variant: "body1"
...
Table.propTypes = {
  ...
  rows: T$1.arrayOf(T$1.shape({
    id: T$1.oneOfType([T$1.string, T$1.number])
  })).isRequired,
  columns: T$1.arrayOf(T$1.shape({
    field: T$1.string,
...
var TextField = function TextField(props) {
  ...
  }, startComponent && /*#__PURE__*/React.createElement("span", {
    className: style$c.startContainer
  }, startComponent), /*#__PURE__*/React.createElement(InputComponent, _extends$g({
    onChange: onChange,
    className: classnames$1(inputClassName, style$c.input)
  }, otherProps)), endComponent && /*#__PURE__*/React.createElement("span", {
...
var Token = function Token(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    alt: "token"
  }), symbol && /*#__PURE__*/React.createElement(Typography, {
    variant: "h6",
    fontFamily: "primary"
  }, symbol));
};
  ...
  _createClass$8(Select, [{
    ...
    function renderInput() {
      ...
      if (!isSearchable) {
        ...
        return /*#__PURE__*/React.createElement(DummyInput, _extends$f({
          id: id,
      ...
      return /*#__PURE__*/React.createElement(Input, _extends$f({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : /*#__PURE__*/React.createElement(Placeholder, _extends$f({}, commonProps, {
          key: "placeholder",
          isDisabled: isDisabled,
          isFocused: isFocused
        }), placeholder);
      ...
      if (isMulti) {
        var selectValues = selectValue.map(function (opt, index) {
          ...
          return /*#__PURE__*/React.createElement(MultiValue, _extends$f({}, commonProps, {
            components: {
      ...
      return /*#__PURE__*/React.createElement(SingleValue, _extends$f({}, commonProps, {
        data: singleValue,
        isDisabled: isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return /*#__PURE__*/React.createElement(ClearIndicator, _extends$f({}, commonProps, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/React.createElement(LoadingIndicator, _extends$f({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return /*#__PURE__*/React.createElement(IndicatorSeparator, _extends$f({}, commonProps, {
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return /*#__PURE__*/React.createElement(DropdownIndicator, _extends$f({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render(props, id) {
        ...
        return /*#__PURE__*/React.createElement(Option, _extends$f({}, commonProps, {
          innerProps: innerProps,
          data: data,
          isDisabled: isDisabled,
          isSelected: isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function (item) {
          if (item.type === 'group') {
            ...
            return /*#__PURE__*/React.createElement(Group, _extends$f({}, commonProps, {
              key: groupId,
              data: data,
              options: options,
      ...
      var menuElement = /*#__PURE__*/React.createElement(MenuPlacer, _extends$f({}, commonProps, menuPlacementProps), function (_ref4) {
        var ref = _ref4.ref,
            _ref4$placerProps = _ref4.placerProps,
            placement = _ref4$placerProps.placement,
            maxHeight = _ref4$placerProps.maxHeight;
        return /*#__PURE__*/React.createElement(Menu, _extends$f({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          return /*#__PURE__*/React.createElement(MenuList, _extends$f({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/React.createElement(MenuPortal, _extends$f({}, commonProps, {
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/React.createElement(LiveRegion, _extends$f({}, commonProps, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(SelectContainer, _extends$f({}, commonProps, {
        className: className,
        innerProps: {
          id: id,
        ...
        isDisabled: isDisabled,
        isFocused: isFocused
      }), this.renderLiveRegion(), /*#__PURE__*/React.createElement(Control, _extends$f({}, commonProps, {
      ...
      }), /*#__PURE__*/React.createElement(ValueContainer, _extends$f({}, commonProps, {
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/React.createElement(IndicatorsContainer, _extends$f({}, commonProps, {
        isDisabled: isDisabled
  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    ...
    _createClass$8(StateManager, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React.createElement(SelectComponent, _extends$f({}, props, {
...
var Select = function Select(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(SelectLibrary, _extends$g({}, props, {
...
var SnackBar = function SnackBar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "body1"
  }, content.message), /*#__PURE__*/React.createElement(Link, {
    onClick: function onClick() {
      return setContent();
    }
  }, "Close"));
...
var ConnectWidget = function ConnectWidget(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    variant: "h1",
    color: "primary"
  }, title), /*#__PURE__*/React.createElement("br", null), connectionStatus === web3States.CONNECTED && /*#__PURE__*/React.createElement("div", null, "Connected"), connectionStatus === web3States.CONNECTING && /*#__PURE__*/React.createElement("div", null, "Connecting"), connectionStatus === web3States.NOT_CONNECTED && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Button, {
    onClick: onClick,
    text: "Connect",
    variant: "primary"
    ...
    variant: "body2",
    align: "center"
  }, "You need a", ' ', /*#__PURE__*/React.createElement("a", {
    href: "https://etherscan.io/directory/Wallet"
  }, "Web3 Enabler"), " to use this Dapp - If you have problems connecting, refresh the page.")), /*#__PURE__*/React.createElement(Modal, {
    centered: true,
    visible: !!modalOpen
  }, /*#__PURE__*/React.createElement("div", {
    ...
    variant: "h5"
  }, activeConnector.label || 'Connect to a wallet'), /*#__PURE__*/React.createElement(Button, {
  ...
  })), activeConnector.name && /*#__PURE__*/React.createElement(React.Fragment, null, wallet.status === 'connecting' && /*#__PURE__*/React.createElement(Typography, {
    variant: "body1"
  }, "Connecting to ", activeConnector.label, " ", /*#__PURE__*/React.createElement(CircularProgress, null)), wallet.status === 'error' && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Typography, {
    variant: "body1"
  }, (_wallet$error = wallet.error) === null || _wallet$error === void 0 ? void 0 : _wallet$error.message), /*#__PURE__*/React.createElement(Button, {
    ...
    text: "Retry"
  })), wallet.status === 'connected' && /*#__PURE__*/React.createElement(Typography, {
    variant: "body1"
...
ConnectWidget.propTypes = {
  ...
  wallet: T$1.shape({
    ...
    status: T$1.oneOf(['disconnected', 'connecting', 'connected', 'error']).isRequired,
    error: T$1.shape({
      name: T$1.string,
      message: T$1.string
    }),
  ...
  connectors: T$1.arrayOf(T$1.shape({
    id: T$1.string,
...
function Field(_ref) {
  ...
  if (component) {
    ...
    if (typeof component === 'string') {
      ...
      return createElement(component, _extends$e({
        ref: innerRef
      }, field, rest), children);
  ...
  if (typeof asElement === 'string') {
    ...
    return createElement(asElement, _extends$e({
      ref: _innerRef
...
var TokenPicker = function TokenPicker(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Select, _extends$g({
    id: "token",
    name: "token",
    options: options,
    valueKey: "token",
...
var EditField = function EditField(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(TextField, _extends$g({
    className: style$3.inputContainer
  }, field, props)), RightInputComponent && RightInputComponent)), description && /*#__PURE__*/React.createElement(ToolTip, {
...
var Swap = function Swap(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var isValid = _ref2.isValid,
        errors = _ref2.errors;
    return /*#__PURE__*/React.createElement(Form, null, /*#__PURE__*/React.createElement(Typography, {
      variant: "body1"
    }, "Propose to swap:"), /*#__PURE__*/React.createElement(EditField, {
      id: "amount",
      name: "amount",
      type: "number",
      min: "0",
      ...
      variant: "body1"
    }, "For:"), /*#__PURE__*/React.createElement(TokenPicker, {
      id: "token",
      name: "token",
      tokenAddress: token.address === VOID_ETHEREUM_ADDRESS ? wethAddress : token.address
    }), errors.amount || errors.token ? /*#__PURE__*/React.createElement(Typography, {
      color: "secondary",
      variant: "subtitle1"
    }, errors.amount || errors.token) : null, /*#__PURE__*/React.createElement(Button, {
      type: "submit",
      disabled: !isValid,
...
var Transfer = function Transfer(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(Form, null, /*#__PURE__*/React.createElement(Typography, {
      variant: "body1"
    }, "Propose to transfer:"), /*#__PURE__*/React.createElement(EditField, {
      id: "amount",
      name: "amount",
      type: "number",
      min: "0",
      ...
      variant: "p"
    }, "To:"), /*#__PURE__*/React.createElement(EditField, {
      id: "address",
      name: "address"
    }), (errors.amount || errors.token) && /*#__PURE__*/React.createElement(Typography, {
      color: "secondary",
      variant: "subtitle1"
    }, errors.amount || errors.token), /*#__PURE__*/React.createElement(Button, {
      type: "submit",
      disabled: !isValid,
      className: style$2.submitButton,
      text: "TRANSFER",
...
var Balance = function Balance(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Card, {
    ...
    symbol: token.symbol,
    logo: token.logo
  }), !!tokenPrice && /*#__PURE__*/React.createElement(Typography, {
    variant: "body1",
    fontFamily: "primary"
  }, "($", tokenPrice, ")")), !!tokenAmount && /*#__PURE__*/React.createElement(Typography, {
    variant: "h5",
    weight: "bold",
    fontFamily: "primary"
  }, tokenAmount), showActions && /*#__PURE__*/React.createElement("div", {
  ...
  })), isSwap && /*#__PURE__*/React.createElement(Swap, {
    token: token,
    onSwapSubmit: onSwapSubmit
  }), isTransfer && /*#__PURE__*/React.createElement(Transfer, {
...
var FileField = function FileField(_ref) {
  ...
  return /*#__PURE__*/React.createElement("section", null, /*#__PURE__*/React.createElement("div", {
    ...
    type: "button",
    color: "tertiary"
  }), /*#__PURE__*/React.createElement("input", _extends$g({
    type: "file",
    ref: hiddenFileInput,
    style: {
      display: 'none'
    ...
    onChange: handleChange
  }))), (value === null || value === void 0 ? void 0 : value.name) && /*#__PURE__*/React.createElement(Typography, {
    variant: "body2"
  }, " ", value === null || value === void 0 ? void 0 : value.name), touched && error ? error : '', description && /*#__PURE__*/React.createElement(ToolTip, {
...
var Checkboard = function Checkboard(_ref) {
  ...
  return isValidElement(children) ? React.cloneElement(children, _extends$8({}, children.props, { style: _extends$8({}, children.props.style, styles.grid) })) : React.createElement('div', { style: styles.grid });
};
...
Github.propTypes = {
  width: T$1.oneOfType([T$1.string, T$1.number]),
  colors: T$1.arrayOf(T$1.string),
  triangle: T$1.oneOf(['hide', 'top-left', 'top-right', 'bottom-left', 'bottom-right']),
  styles: T$1.object
};
...
SketchPresetColors.propTypes = {
  colors: T$1.arrayOf(T$1.oneOfType([T$1.string, T$1.shape({
    color: T$1.string,
    title: T$1.string
  })])).isRequired
};
...
var ColorField = function ColorField(_ref) {
  ...
  var handleChangeColor = useCallback(function (color, event) {
    helpers.setValue(color.hex);
    event.stopPropagation();
    event.preventDefault();
  }, [helpers]);
  var handleChangeComplete = useCallback(function (color, event) {
    helpers.setValue(color.hex);
    event.stopPropagation();
    event.preventDefault();
  }, [helpers]);
  ...
  }, "\xA0"), showPicker && /*#__PURE__*/React.createElement(OutsideManager, {
...
export { Balance, Button, Card, Chip, CircularProgress, ColorField, ConnectWidget, Container, EditField, ErrorMessage, FastField, Field, FieldArray, FileField, Form, FormControl, Formik, FormikConsumer, FormikContext, FormikProvider, LinearProgress, Link, Modal, Select, ShinyText, SnackBar, Table, TextField, Token, ToolTip as Tooltip, Typography, index as Yup, connect, getActiveElement, getIn$1 as getIn, insert, isEmptyArray, isEmptyChildren, isFunction$1 as isFunction, isInputEvent, isInteger, isNaN$1$1 as isNaN, isObject$2 as isObject, isPromise, isString$1 as isString, move, prepareDataForValidation, replace, setIn, setNestedObjectValues, swap, useField, useFormik, useFormikContext, validateYupSchema, withFormik, yupToFormErrors };
