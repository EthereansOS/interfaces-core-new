...
var style$m = {
  root: 'ethereans-interfaces_button_root',
  primary: 'ethereans-interfaces_button_primary',
  secondary: 'ethereans-interfaces_button_secondary',
  tertiary: 'ethereans-interfaces_button_tertiary',
  small: 'ethereans-interfaces_button_small',
  medium: 'ethereans-interfaces_button_medium',
  large: 'ethereans-interfaces_button_large',
  fullWidth: 'ethereans-interfaces_button_fullWidth',
}
...
var style$l = {
  root: 'ethereans-interfaces_card_root',
  content: 'ethereans-interfaces_card_content',
  footer: 'ethereans-interfaces_card_footer',
  header: 'ethereans-interfaces_card_header',
}
...
var style$k = {
  root: 'ethereans-interfaces_chip_root',
  primary: 'ethereans-interfaces_chip_primary',
  secondary: 'ethereans-interfaces_chip_secondary',
  small: 'ethereans-interfaces_chip_small',
  medium: 'ethereans-interfaces_chip_medium',
  large: 'ethereans-interfaces_chip_large',
}
...
Container.propTypes = {
  className: T__default['default'].string,
  children: T__default['default'].oneOfType([
    T__default['default'].arrayOf(T__default['default'].node),
    T__default['default'].node,
  ]),
}

var style$i = {
  root: 'ethereans-interfaces_typography_root',
  'color-primary': 'ethereans-interfaces_typography_color-primary',
  'color-secondary': 'ethereans-interfaces_typography_color-secondary',
  'font-primary': 'ethereans-interfaces_typography_font-primary',
  'font-secondary': 'ethereans-interfaces_typography_font-secondary',
  left: 'ethereans-interfaces_typography_left',
  center: 'ethereans-interfaces_typography_center',
  right: 'ethereans-interfaces_typography_right',
}
...
var Typography = function Typography(props) {
  ...
  if (['primary', 'secondary'].includes(color)) {
    attr.className = classnames$1(
      attr.className,
      style$i['color-'.concat(color)]
    )
  } else {
    color &&
      (attr.style = {
  ...
  if (['primary', 'secondary'].includes(fontFamily)) {
    attr.className = classnames$1(
      attr.className,
      style$i['font-'.concat(fontFamily)]
    )
  }
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    as || variantToTags[variant] || variant,
    _objectSpread2$1(
      _objectSpread2$1({}, attr),
      {},
      {
        children: children,
      }
...
Typography.propTypes = {
  ...
  variant: T__default['default'].oneOf([
    'h1',
    'h2',
    'h3',
    'h4',
  ...
  weight: T__default['default'].oneOfType([
    T__default['default'].string,
    T__default['default'].number,
  ]),
...
var style$f = {
  root: 'ethereans-interfaces_modal_root',
  centered: 'ethereans-interfaces_modal_centered',
  centeredContainer: 'ethereans-interfaces_modal_centeredContainer',
  fullWindow: 'ethereans-interfaces_modal_fullWindow',
}
...
var style$e = {
  root: 'ethereans-interfaces_shinyText_root',
  always: 'ethereans-interfaces_shinyText_always',
  hover: 'ethereans-interfaces_shinyText_hover',
  animated: 'ethereans-interfaces_shinyText_animated',
  shine: 'ethereans-interfaces_shinyText_shine',
  strong: 'ethereans-interfaces_shinyText_strong',
}
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    'span',
    {
      className: classnames$1(
        style$e.root,
        ((_classNames = {}),
        _defineProperty$4(_classNames, style$e.always, !hover),
        _defineProperty$4(_classNames, style$e.animated, !!animated),
        _defineProperty$4(_classNames, style$e.hover, !!hover),
        _defineProperty$4(_classNames, style$e.strong, !!strong),
        _classNames),
        className
      ),
    },
...
Table.propTypes = {
  ...
  rows: T__default['default'].arrayOf(
    T__default['default'].shape({
      id: T__default['default'].oneOfType([
        T__default['default'].string,
        T__default['default'].number,
      ]),
    })
  ).isRequired,
  columns: T__default['default'].arrayOf(
    T__default['default'].shape({
...
var style$c = {
  root: 'ethereans-interfaces_textField_root',
  rounded: 'ethereans-interfaces_textField_rounded',
  input: 'ethereans-interfaces_textField_input',
  startContainer: 'ethereans-interfaces_textField_startContainer',
  endContainer: 'ethereans-interfaces_textField_endContainer',
}
...
var style$a = {
  root: 'ethereans-interfaces_linear-progress_root',
  primary: 'ethereans-interfaces_linear-progress_primary',
  secondary: 'ethereans-interfaces_linear-progress_secondary',
  'lds-ellipsis1': 'ethereans-interfaces_linear-progress_lds-ellipsis1',
  'lds-ellipsis2': 'ethereans-interfaces_linear-progress_lds-ellipsis2',
  'lds-ellipsis3': 'ethereans-interfaces_linear-progress_lds-ellipsis3',
}
...
var style$9 = {
  root: 'ethereans-interfaces_circular-progress_root',
  spin: 'ethereans-interfaces_circular-progress_spin',
  primary: 'ethereans-interfaces_circular-progress_primary',
  secondary: 'ethereans-interfaces_circular-progress_secondary',
  small: 'ethereans-interfaces_circular-progress_small',
  medium: 'ethereans-interfaces_circular-progress_medium',
  large: 'ethereans-interfaces_circular-progress_large',
}
...
function m$1(e, r) {
  return (
    (((((((r << 2) ^ z$1(e, 0)) << 2) ^ z$1(e, 1)) << 2) ^ z$1(e, 2)) << 2) ^
    z$1(e, 3)
  )
}
function g$1(e) {
...
function V(e) {
  return g$1(Q(E - 1, _(e === 91 ? e + 2 : e === 40 ? e + 1 : e)))
}
function X(e) {
  while ((F = N()))
    if (F < 33) L()
...
function ue(c, n) {
  switch (m$1(c, n)) {
    ...
    case 5187:
      return (
        a + c + y$1(c, /(\w+).+(:[^]+)/, a + 'box-$1$2' + e$1 + 'flex-$1$2') + c
      )
    case 5443:
    ...
    case 6187:
      return (
        y$1(
          y$1(y$1(c, /(zoom-|grab)/, a + '$1'), /(image-set)/, a + '$1'),
          c,
          ''
        ) + c
      )
    ...
    case 4968:
      return (
        y$1(
          y$1(c, /(.+:)(flex-)?(.*)/, a + 'box-pack:$3' + e$1 + 'flex-pack:$3'),
          /s.+-b[^;]+/,
          'justify'
        ) +
        a +
    ...
    case 4765:
      if (A$1(c) - 1 - n > 6)
        switch (z$1(c, n + 1)) {
          ...
          case 115:
            return ~j$1(c, 'stretch')
              ? ue(y$1(c, 'stretch', 'fill-available'), n) + c
              : c
        }
      break
    case 4949:
    ...
    case 6444:
      switch (z$1(c, A$1(c) - 3 - (~j$1(c, '!important') && 10))) {
        case 107:
          return y$1(c, ':', ':' + a) + c
        case 101:
          return (
        ...
        if (c.length)
          return S(c.props, function (n) {
            switch (x$1(n, /(::plac\w+|:read-\w+)/)) {
              ...
              case ':read-write':
                return ie(
                  [I(y$1(n, /:(read-\w+)/, ':' + r$1 + '$1'), c, '')],
                  i
                )
              case '::placeholder':
                return ie(
                  [
                    I(y$1(n, /:(plac\w+)/, ':' + a + 'input-$1'), c, ''),
                    I(y$1(n, /:(plac\w+)/, ':' + r$1 + '$1'), c, ''),
                    I(y$1(n, /:(plac\w+)/, e$1 + 'input-$1'), c, ''),
                  ],
                  i
                )
            }
...
var Emotion = /* #__PURE__ */ withEmotionCache(function (props, cache, ref) {
  ...
  for (var key in props) {
    if (
      hasOwnProperty$r.call(props, key) &&
      key !== 'css' &&
      key !== typePropName &&
...
var cleanCommonProps = function cleanCommonProps(props) {
  ...
  props.setValue
  props.theme
  var innerProps = _objectWithoutProperties(props, [
    'className',
    'clearValue',
    'cx',
    'getStyles',
  ...
  _createClass$8(MenuPortal, [
    {
      ...
      value: function render() {
        ...
        return jsx(
          ...
          appendTo
            ? /*#__PURE__*/ reactDom.createPortal(menuWrapper, appendTo)
            : menuWrapper
        )
      },
    },
...
var _ref2$1 =
  process.env.NODE_ENV === 'production'
    ...
    : {
        name: 'tj5bde-Svg',
        styles:
          'display:inline-block;fill:currentColor;line-height:1;stroke:currentColor;strokeWidth:0;label:Svg;',
...
var Input = function Input(props) {
  ...
  var _cleanCommonProps = cleanCommonProps(props),
    ...
    innerProps = _objectWithoutProperties(_cleanCommonProps, [
      'innerRef',
      'isDisabled',
      'isHidden',
    ])
      ...
      },
      {
        ...
        value: function renderMenu() {
          ...
          if (this.hasOptions()) {
            ...
            menuUI = /*#__PURE__*/ React__default['default'].createElement(
              LoadingMessage,
              commonProps,
              message
            )
          ...
          var menuElement = /*#__PURE__*/ React__default[
            'default'
          ].createElement(
            MenuPlacer,
            _extends$f({}, commonProps, menuPlacementProps),
            function (_ref4) {
              var ref = _ref4.ref,
        ...
        _createClass$8(StateManager, [
          ...
          },
          {
            ...
            value: function render() {
              ...
              var props = _objectWithoutProperties(_this$props2, [
                'defaultInputValue',
                'defaultMenuIsOpen',
                'defaultValue',
              ])
...
var style$7 = {
  label: 'ethereans-interfaces_select_label',
  image: 'ethereans-interfaces_select_image',
}
...
var Select = function Select(_ref) {
  ...
  var formattedOptions = React.useMemo(
    function () {
      return options.map(function (option) {
        return _objectSpread2$1(
          _objectSpread2$1({}, option),
          {},
          {
    ...
    option: function option(styles, _ref2) {
      ...
      return _objectSpread2$1(
        ...
        {},
        {
          ...
          ':active': _objectSpread2$1(
            _objectSpread2$1({}, styles[':active']),
            {},
            {
...
Select.propTypes = {
  ...
  options: T__default['default'].arrayOf(T__default['default'].object)
    .isRequired,
...
var style$6 = {
  root: 'ethereans-interfaces_snack-bar_root',
  error: 'ethereans-interfaces_snack-bar_error',
  warning: 'ethereans-interfaces_snack-bar_warning',
  success: 'ethereans-interfaces_snack-bar_success',
}
...
var style$5 = {
  root: 'ethereans-interfaces_connect-widget_root',
  rotateLogo: 'ethereans-interfaces_connect-widget_rotateLogo',
  spin: 'ethereans-interfaces_connect-widget_spin',
  button: 'ethereans-interfaces_connect-widget_button',
  modalHeader: 'ethereans-interfaces_connect-widget_modalHeader',
  retryButton: 'ethereans-interfaces_connect-widget_retryButton',
}
...
var ConnectWidget = function ConnectWidget(_ref) {
  ...
  var onClick = function onClick() {
    setModalOpen(true)
    onClickConnect === null || onClickConnect === void 0
      ? void 0
      : onClickConnect()
  }
  ...
  var onConnectorClicked = /*#__PURE__*/ (function () {
    var _ref2 = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee(name, label) {
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    logo
      ? /*#__PURE__*/ React__default['default'].createElement('img', {
          ...
          alt: 'logo',
          className: classnames$1(
            _defineProperty$4({}, style$5.rotateLogo, !!rotateLogo)
          ),
        })
      : null,
    /*#__PURE__*/ React__default['default'].createElement(
    ...
    connectionStatus === interfacesCore.web3States.CONNECTED &&
      /*#__PURE__*/ React__default['default'].createElement(
        'div',
        null,
        'Connected'
      ),
    connectionStatus === interfacesCore.web3States.CONNECTING &&
      /*#__PURE__*/ React__default['default'].createElement(
        'div',
        null,
        'Connecting'
      ),
    connectionStatus === interfacesCore.web3States.NOT_CONNECTED &&
      /*#__PURE__*/ React__default['default'].createElement(
        React__default['default'].Fragment,
        null,
        ...
        /*#__PURE__*/ React__default['default'].createElement(
          ...
          ' to use this Dapp - If you have problems connecting, refresh the page.'
        )
      ),
    /*#__PURE__*/ React__default['default'].createElement(
      Modal,
          ...
          wallet.status === 'error' &&
            /*#__PURE__*/ React__default['default'].createElement(
              ...
              /*#__PURE__*/ React__default['default'].createElement(
                ...
                (_wallet$error = wallet.error) === null ||
                  _wallet$error === void 0
                  ? void 0
                  : _wallet$error.message
              ),
              /*#__PURE__*/ React__default['default'].createElement(Button, {
...
ConnectWidget.propTypes = {
  ...
  wallet: T__default['default'].shape({
    ...
    status: T__default['default'].oneOf([
      'disconnected',
      'connecting',
      'connected',
      'error',
  ...
  connectors: T__default['default'].arrayOf(
    T__default['default'].shape({
...
function hashHas$1(key) {
  ...
  return nativeCreate$2
    ? data[key] !== undefined
    : hasOwnProperty$m.call(data, key)
}
...
function assignValue$1(object, key, value) {
  ...
  if (
    !(hasOwnProperty$l.call(object, key) && eq$1(objValue, value)) ||
...
var isArguments$1 = baseIsArguments$1(
  ...
  : function (value) {
      return (
        ...
        hasOwnProperty$k.call(value, 'callee') &&
...
typedArrayTags$1[float32Tag$5] =
  ...
  typedArrayTags$1[uint32Tag$5] =
    true
typedArrayTags$1[argsTag$6] =
  typedArrayTags$1[arrayTag$5] =
  typedArrayTags$1[arrayBufferTag$7] =
  typedArrayTags$1[boolTag$7] =
  typedArrayTags$1[dataViewTag$9] =
  typedArrayTags$1[dateTag$7] =
  typedArrayTags$1[errorTag$5] =
  typedArrayTags$1[funcTag$4] =
  typedArrayTags$1[mapTag$b] =
  typedArrayTags$1[numberTag$7] =
  typedArrayTags$1[objectTag$8] =
  typedArrayTags$1[regexpTag$7] =
  typedArrayTags$1[setTag$b] =
  typedArrayTags$1[stringTag$8] =
...
function baseIsTypedArray$1(value) {
  return (
    ...
    !!typedArrayTags$1[baseGetTag$1(value)]
  )
}
 ...
 * // => false
 */
var isTypedArray$1 = nodeIsTypedArray$1
  ? baseUnary$1(nodeIsTypedArray$1)
  : baseIsTypedArray$1
...
function arrayLikeKeys$1(value, inherited) {
  ...
  for (var key in value) {
    if (
      (inherited || hasOwnProperty$j.call(value, key)) &&
      !(
        skipIndexes &&
...
function baseKeysIn$1(object) {
  ...
  for (var key in object) {
    if (
      !(
        key == 'constructor' &&
        (isProto || !hasOwnProperty$h.call(object, key))
      )
    ) {
      result.push(key)
    }
 ...
 */
var getSymbols$1 = !nativeGetSymbols$3
  ? stubArray$1
  : function (object) {
      if (object == null) {
        return []
...
if (
  (DataView$2 &&
    getTag$1(new DataView$2(new ArrayBuffer(1))) != dataViewTag$8) ||
...
function initCloneArray$1(array) {
  ...
  if (
    ...
    hasOwnProperty$g.call(array, 'index')
  ) {
...
var cloneableTags$1 = {}
cloneableTags$1[argsTag$5] =
  cloneableTags$1[arrayTag$4] =
  cloneableTags$1[arrayBufferTag$5] =
  cloneableTags$1[dataViewTag$6] =
  cloneableTags$1[boolTag$5] =
  cloneableTags$1[dateTag$5] =
  ...
  cloneableTags$1[mapTag$7] =
  cloneableTags$1[numberTag$5] =
  cloneableTags$1[objectTag$6] =
  cloneableTags$1[regexpTag$5] =
  cloneableTags$1[setTag$7] =
  cloneableTags$1[stringTag$6] =
  cloneableTags$1[symbolTag$6] =
  cloneableTags$1[uint8Tag$3] =
  cloneableTags$1[uint8ClampedTag$3] =
  cloneableTags$1[uint16Tag$3] =
  cloneableTags$1[uint32Tag$3] =
    true
cloneableTags$1[errorTag$4] =
...
function baseClone$2(value, bitmask, customizer, key, object, stack) {
  ...
  if (isSet$2(value)) {
    value.forEach(function (subValue) {
      result.add(
        baseClone$2(subValue, bitmask, customizer, subValue, value, stack)
      )
    })
...
var stringToPath$1 = memoizeCapped$1(function (string) {
  ...
  string.replace(rePropName$1, function (match, number, quote, subString) {
    result.push(
      quote ? subString.replace(reEscapeChar$1, '$1') : number || match
    )
  })
  return result
})
...
function toPath(value) {
  ...
  return isSymbol$1(value)
    ? [value]
    : copyArray$1(stringToPath$2(toString$2(value)))
}
...
function useFormik(_ref) {
  ...
  React.useEffect(
    function () {
      if (
        validateOnMount &&
        isMounted.current === true &&
        reactFastCompare(initialValues.current, props.initialValues)
      ) {
  ...
  React.useEffect(
    function () {
      if (
        enableReinitialize &&
        isMounted.current === true &&
        !reactFastCompare(initialErrors.current, props.initialErrors)
      ) {
  ...
  React.useEffect(
    function () {
      if (
        enableReinitialize &&
        isMounted.current === true &&
        !reactFastCompare(initialTouched.current, props.initialTouched)
      ) {
  ...
  React.useEffect(
    function () {
      if (
        enableReinitialize &&
        isMounted.current === true &&
        !reactFastCompare(initialStatus.current, props.initialStatus)
      ) {
  ...
  var validateField = useEventCallback(function (name) {
    ...
    if (
      ...
      isFunction$1(fieldRegistry.current[name].validate)
    ) {
    ...
    function (eventOrTextValue, maybePath) {
      ...
      if (!isString$1(eventOrTextValue)) {
        ...
        val = /number|range/.test(type)
          ...
          ? getValueForCheckbox(getIn$1(state.values, field), checked, value)
...
function Field(_ref) {
  var validate = _ref.validate,
    ...
    props = _objectWithoutPropertiesLoose$1(_ref, [
      'validate',
      'name',
      'render',
      'children',
  ...
  var _useFormikContext = useFormikContext(),
    formik = _objectWithoutPropertiesLoose$1(_useFormikContext, [
      'validate',
      'validationSchema',
    ])
    ...
    React.useEffect(function () {
      !!render
        ? process.env.NODE_ENV !== 'production'
          ...
          : warning(false)
        : void 0
      !!(is && children && isFunction$1(children))
        ? process.env.NODE_ENV !== 'production'
          ? warning(
              false,
          ...
          : warning(false)
        : void 0
      !!(component && children && isFunction$1(children))
        ? process.env.NODE_ENV !== 'production'
          ? warning(
              false,
...
var FieldArrayInner = /*#__PURE__*/ (function (_React$Component) {
    ...
    _this.updateArrayField = function (fn, alterTouched, alterErrors) {
      ...
      setFormikState(function (prevState) {
        ...
        var values = setIn(
          prevState.values,
          name,
          fn(getIn$1(prevState.values, name))
        )
        var fieldError = alterErrors
          ? updateErrors(getIn$1(prevState.errors, name))
          : undefined
        var fieldTouched = alterTouched
          ? updateTouched(getIn$1(prevState.touched, name))
          : undefined
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (
      ...
      !reactFastCompare(
        getIn$1(prevProps.formik.values, prevProps.name),
        getIn$1(this.props.formik.values, this.props.name)
      )
    ) {
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
      ...
      restOfFormik = _objectWithoutPropertiesLoose$1(_this$props2$formik, [
        'validate',
        'validationSchema',
      ])
...
var ErrorMessageImpl = /*#__PURE__*/ (function (_React$Component) {
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(props) {
    if (
      getIn$1(this.props.formik.errors, this.props.name) !==
        getIn$1(props.formik.errors, this.props.name) ||
      getIn$1(this.props.formik.touched, this.props.name) !==
        getIn$1(props.formik.touched, this.props.name) ||
...
var FastFieldInner = /*#__PURE__*/ (function (_React$Component) {
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(props) {
    if (this.props.shouldUpdate) {
      ...
      getIn$1(props.formik.values, this.props.name) !==
        getIn$1(this.props.formik.values, this.props.name) ||
      getIn$1(props.formik.errors, this.props.name) !==
        getIn$1(this.props.formik.errors, this.props.name) ||
      getIn$1(props.formik.touched, this.props.name) !==
  ...
  _proto.render = function render() {
    ...
    var restOfFormik = _objectWithoutPropertiesLoose$1(formik, [
      'validate',
      'validationSchema',
    ])
        ...
        return {
          id:
            (pair === null || pair === void 0
              ? void 0
              : (_pair$token = pair.token1) === null || _pair$token === void 0
              ? void 0
              : _pair$token.address) || pair.address,
          label:
            pair !== null &&
            pair !== void 0 &&
            (_pair$token2 = pair.token1) !== null &&
            _pair$token2 !== void 0 &&
            _pair$token2.name
              ? ''
                  .concat(pair.token1.name, ' (')
                  .concat(pair.token1.symbol, ')')
              : pair.symbol,
        }
      })
    },
...
function baseClone$1(src, circulars, clones) {
  ...
  if (src instanceof Object) {
    ...
    for (var key in src) {
      ...
      obj[key] =
        idx > -1 ? clones[idx] : baseClone$1(src[key], circulars, clones)
    }
    return obj
  }
...
var isArguments = _baseIsArguments(
  ...
  : function (value) {
      return (
        ...
        hasOwnProperty$a.call(value, 'callee') &&
...
typedArrayTags[argsTag$3] =
  typedArrayTags[arrayTag$3] =
  typedArrayTags[arrayBufferTag$4] =
  typedArrayTags[boolTag$4] =
  typedArrayTags[dataViewTag$5] =
  typedArrayTags[dateTag$4] =
  typedArrayTags[errorTag$3] =
  typedArrayTags[funcTag$1] =
  typedArrayTags[mapTag$6] =
  typedArrayTags[numberTag$4] =
  typedArrayTags[objectTag$5] =
  typedArrayTags[regexpTag$4] =
  typedArrayTags[setTag$6] =
  typedArrayTags[stringTag$5] =
...
function arrayLikeKeys(value, inherited) {
  ...
  for (var key in value) {
    if (
      (inherited || hasOwnProperty$9.call(value, key)) &&
      !(
        skipIndexes &&
        // Safari 9 has enumerable `arguments.length` in strict mode.
        (key == 'length' ||
...
// Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.
if (
  (_DataView && getTag(new _DataView(new ArrayBuffer(1))) != dataViewTag$3) ||
      ...
      if (
        !(result === undefined
          ? _baseIsEqual(
              srcValue,
              objValue,
              COMPARE_PARTIAL_FLAG$7 | COMPARE_UNORDERED_FLAG$5,
              customizer,
              stack
            )
          : result)
  ...
  return function (object) {
    ...
    return objValue === undefined && objValue === srcValue
      ...
      : _baseIsEqual(
          srcValue,
          objValue,
          COMPARE_PARTIAL_FLAG$6 | COMPARE_UNORDERED_FLAG$4
        )
  }
}
...
function createValidation(config) {
  function validate(_ref, cb) {
    ...
    try {
      ...
      if (
        typeof ((_ref2 = result) == null ? void 0 : _ref2.then) === 'function'
      ) {
        throw new Error(
...
class NumberSchema extends BaseSchema {
  ...
  round(method) {
    ...
    method =
      ((_method = method) == null ? void 0 : _method.toLowerCase()) || 'round' // this exists for symemtry with the new Math.trunc
...
function findIndex(arr, err) {
  ...
  arr.some((key, ii) => {
    ...
    if (
      ((_err$path = err.path) == null ? void 0 : _err$path.indexOf(key)) !== -1
    ) {
      idx = ii
      return true
    }
...
var style$3 = {
  header: 'ethereans-interfaces_edit-field_header',
  inputContainer: 'ethereans-interfaces_edit-field_inputContainer',
  tooltip: 'ethereans-interfaces_edit-field_tooltip',
  inputWrapper: 'ethereans-interfaces_edit-field_inputWrapper',
}
...
var style$2 = {
  root: 'ethereans-interfaces_balance_root',
  token: 'ethereans-interfaces_balance_token',
  amount: 'ethereans-interfaces_balance_amount',
  actions: 'ethereans-interfaces_balance_actions',
  transfer: 'ethereans-interfaces_balance_transfer',
  swap: 'ethereans-interfaces_balance_swap',
    ...
    /*#__PURE__*/ React__default['default'].createElement(
      ...
      function (_ref2) {
        ...
        return /*#__PURE__*/ React__default['default'].createElement(
          ...
          /*#__PURE__*/ React__default['default'].createElement(EditField, {
            id: 'amount',
            name: 'amount',
            type: 'number',
            min: '0',
            step: 0.000000001,
            RightInputComponent: /*#__PURE__*/ React__default[
              'default'
            ].createElement(Token, {
              symbol: token.symbol,
            }),
          ...
          /*#__PURE__*/ React__default['default'].createElement(TokenPicker, {
            id: 'token',
            name: 'token',
            tokenAddress:
              token.address === interfacesCore.VOID_ETHEREUM_ADDRESS
                ? wethAddress
                : token.address,
          }),
...
var Balance = function Balance(_ref) {
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    isTransfer &&
      /*#__PURE__*/ React__default['default'].createElement(Transfer, {
...
Balance.propTypes = {
  ...
  tokenPrice: T__default['default'].oneOfType([
    T__default['default'].string,
    T__default['default'].number,
  ]),
...
var style$1 = {
  header: 'ethereans-interfaces_file-field_header',
  inputContainer: 'ethereans-interfaces_file-field_inputContainer',
  tooltip: 'ethereans-interfaces_file-field_tooltip',
}
...
function _checkCoverSize() {
  _checkCoverSize = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee4(file) {
      var cover
          ...
          (_ret =
            ((_temp =
              ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                  Hover.__proto__ || Object.getPrototypeOf(Hover)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
          ...
          (_ret =
            ((_temp =
              ((_this = _possibleConstructorReturn(
                this,
                (_ref =
                  Active.__proto__ || Object.getPrototypeOf(Active)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              )),
...
var calculateChange$2 = function calculateChange(
  e,
  hsl,
  direction,
  initialA,
...
var Checkboard = function Checkboard(_ref) {
  ...
  var styles = reactCSS({
    default: {
      grid: {
        ...
        background:
          'url(' + get$1(white, grey, size, renderers.canvas) + ') center left',
      },
    },
  })
  return React.isValidElement(children)
    ? React__default['default'].cloneElement(
        children,
        _extends$8({}, children.props, {
          style: _extends$8({}, children.props.style, styles.grid),
        })
      )
    : React__default['default'].createElement('div', { style: styles.grid })
}
...
var Alpha = (function (_ref) {
  ...
  function Alpha() {
    ...
    return (
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn$7(
            this,
            (_ref2 =
              Alpha.__proto__ || Object.getPrototypeOf(Alpha)).call.apply(
              _ref2,
              [this].concat(args)
            )
          )),
        ...
        _temp)),
      _possibleConstructorReturn$7(_this, _ret)
    )
  }
      ...
      value: function render() {
        ...
        return React__default['default'].createElement(
          ...
          React__default['default'].createElement(
            ...
            React__default['default'].createElement(Checkboard, {
...
var EditableInput = (function (_ref) {
  ...
  function EditableInput(props) {
    ...
    var _this = _possibleConstructorReturn$6(
      this,
      (EditableInput.__proto__ || Object.getPrototypeOf(EditableInput)).call(
        this
      )
    )
      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn$5(
            this,
            (_ref2 = Hue.__proto__ || Object.getPrototypeOf(Hue)).call.apply(
              _ref2,
              [this].concat(args)
            )
          )),
    ...
    },
    {
      ...
      value: function render() {
        ...
        var _props$direction = this.props.direction,
          direction =
            _props$direction === undefined ? 'horizontal' : _props$direction
  ...
  function Saturation(props) {
    ...
    _this.handleChange = function (e) {
      typeof _this.props.onChange === 'function' &&
        _this.throttle(
          _this.props.onChange,
          calculateChange(e, _this.props.hsl, _this.container),
          e
        )
    }
        ...
        (_ret =
          ((_temp =
            ((_this = _possibleConstructorReturn$2(
              this,
              (_ref =
                Focus.__proto__ || Object.getPrototypeOf(Focus)).call.apply(
                _ref,
                [this].concat(args)
              )
            )),
    ...
    _createClass$2(Focus, [
      {
        ...
        value: function render() {
          return React__default['default'].createElement(
            ...
            React__default['default'].createElement(
              Component,
              _extends$5({}, this.props, this.state)
            )
          )
        },
      },
...
var Block = function Block(_ref) {
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      'div',
      { style: styles.body },
      React__default['default'].createElement(BlockSwatches, {
        colors: colors,
...
Block.propTypes = {
  width: T__default['default'].oneOfType([
    T__default['default'].string,
    T__default['default'].number,
  ]),
...
var UnfoldMoreHorizontalIcon$1 = /*@__PURE__*/ getDefaultExportFromCjs(
...
var ChromeFields = (function (_React$Component) {
  ...
  function ChromeFields(props) {
    ...
    var _this = _possibleConstructorReturn$1(
      this,
      (ChromeFields.__proto__ || Object.getPrototypeOf(ChromeFields)).call(this)
    )
...
var Compact = function Compact(_ref) {
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      ...
      React__default['default'].createElement(CompactFields, {
        hex: hex,
        rgb: rgb,
        onChange: handleChange,
      })
...
Github.propTypes = {
  ...
  colors: T__default['default'].arrayOf(T__default['default'].string),
  triangle: T__default['default'].oneOf([
    'hide',
    'top-left',
    'top-right',
    'bottom-left',
...
var Photoshop = (function (_React$Component) {
  ...
  function Photoshop(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (Photoshop.__proto__ || Object.getPrototypeOf(Photoshop)).call(this)
    )
            ...
            React__default['default'].createElement(
              ...
              React__default['default'].createElement(
                ...
                React__default['default'].createElement(
                  ...
                  React__default['default'].createElement(PhotoshopButton, {
                    label: 'OK',
...
SketchPresetColors.propTypes = {
  colors: T__default['default'].arrayOf(
    T__default['default'].oneOfType([
      T__default['default'].string,
      T__default['default'].shape({
        color: T__default['default'].string,
        title: T__default['default'].string,
...
var Slider = function Slider(_ref) {
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      'div',
      { style: styles.swatches },
      React__default['default'].createElement(SliderSwatches, {
        hsl: hsl,
        onClick: onChange,
      })
    )
...
Swatches.propTypes = {
  ...
  height: T__default['default'].oneOfType([
    T__default['default'].string,
    T__default['default'].number,
  ]),
  colors: T__default['default'].arrayOf(
    T__default['default'].arrayOf(T__default['default'].string)
  ),
  styles: T__default['default'].object,
...
var GoogleFields = function GoogleFields(_ref) {
  ...
  var handleChange = function handleChange(data, e) {
    if (data.hex) {
      ...
      isvalidColorString(data.rgb, 'rgb') &&
        onChange(
          {
            r: values[0],
            g: values[1],
...
var style = {
  header: 'ethereans-interfaces_color-field_header',
  inputContainer: 'ethereans-interfaces_color-field_inputContainer',
  picker: 'ethereans-interfaces_color-field_picker',
  innerPicker: 'ethereans-interfaces_color-field_innerPicker',
  pickerComponent: 'ethereans-interfaces_color-field_pickerComponent',
  tooltip: 'ethereans-interfaces_color-field_tooltip',
}
...
var ColorField = function ColorField(_ref) {
  ...
  var handleChangeColor = React.useCallback(
  ...
  var handleChangeComplete = React.useCallback(
    function (color, event) {
      helpers.setValue(color.hex)
      event.stopPropagation()
      event.preventDefault()
