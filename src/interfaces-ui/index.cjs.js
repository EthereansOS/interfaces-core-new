...
var T$1 = require('prop-types');
var interfacesCore = require('interfaces-core');
...
var sizePropType = T__default["default"].oneOf(['small', 'medium', 'large']);

var style$m = {"root":"ethereans-interfaces_button_root","primary":"ethereans-interfaces_button_primary","secondary":"ethereans-interfaces_button_secondary","tertiary":"ethereans-interfaces_button_tertiary","small":"ethereans-interfaces_button_small","medium":"ethereans-interfaces_button_medium","large":"ethereans-interfaces_button_large","fullWidth":"ethereans-interfaces_button_fullWidth"};

var _excluded$6 = ["text", "className", "color", "size", "fullWidth"];
...
var Button = function Button(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("button", _extends$g({}, props, {
    className: classnames$1(style$m.root, style$m[color], style$m[size], style$m[fullWidth ? 'fullWidth' : ''], className)
  }), text);
};

Button.propTypes = {
  className: T__default["default"].string,
  text: T__default["default"].string.isRequired,
  type: T__default["default"].oneOf(['submit', 'button']),
  fullWidth: T__default["default"].bool,
  color: T__default["default"].oneOf(['primary', 'secondary', 'tertiary']),
  size: sizePropType
};
Button.defaultProps = {
  color: 'primary',
...
var style$l = {"root":"ethereans-interfaces_card_root","content":"ethereans-interfaces_card_content","footer":"ethereans-interfaces_card_footer","header":"ethereans-interfaces_card_header"};
...
var Card = function Card(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("article", {
    className: classnames$1(style$l.root, className)
  }, Header && /*#__PURE__*/React__default["default"].createElement("header", {
    className: classnames$1(style$l.header, headerClassName)
  }, Header), /*#__PURE__*/React__default["default"].createElement("section", {
    className: classnames$1(style$l.content, contentClassName)
  }, children), Footer && /*#__PURE__*/React__default["default"].createElement("footer", {
    className: classnames$1(style$l.footer, footerClassName)
  }, Footer));
};
Card.propTypes = {
  footerClassName: T__default["default"].string,
  headerClassName: T__default["default"].string,
  children: T__default["default"].node,
  Footer: T__default["default"].node,
  Header: T__default["default"].node,
  className: T__default["default"].string,
  contentClassName: T__default["default"].string
};

var style$k = {"root":"ethereans-interfaces_chip_root","primary":"ethereans-interfaces_chip_primary","secondary":"ethereans-interfaces_chip_secondary","small":"ethereans-interfaces_chip_small","medium":"ethereans-interfaces_chip_medium","large":"ethereans-interfaces_chip_large"};
...
var Chip = function Chip(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("span", {
    className: classnames$1(style$k.root, style$k[color], style$k[size], className)
  }, label || children);
};
Chip.propTypes = {
  label: T__default["default"].string,
...
var style$j = {"root":"ethereans-interfaces_container_root"};

var Container = function Container(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$j.root, className)
  }, children);
};

Container.propTypes = {
  className: T__default["default"].string,
  children: T__default["default"].oneOfType([T__default["default"].arrayOf(T__default["default"].node), T__default["default"].node])
};

var style$i = {"root":"ethereans-interfaces_typography_root","color-primary":"ethereans-interfaces_typography_color-primary","color-secondary":"ethereans-interfaces_typography_color-secondary","font-primary":"ethereans-interfaces_typography_font-primary","font-secondary":"ethereans-interfaces_typography_font-secondary","left":"ethereans-interfaces_typography_left","center":"ethereans-interfaces_typography_center","right":"ethereans-interfaces_typography_right"};
...
var Typography = function Typography(props) {
  var children = props.children,
      ...
      as = props.as;
  var attr = {
    className: classnames$1(style$i.root, className),
    style: _objectSpread2$1({}, weight && {
      fontWeight: weight
    })
  };

  if (['body1', 'body2', 'subtitle1', 'subtitle2'].includes(variant)) {
    attr.className = classnames$1(attr.className, variant);
  }

  if (['primary', 'secondary'].includes(color)) {
    attr.className = classnames$1(attr.className, style$i["color-".concat(color)]);
  } else {
    color && (attr.style = {
      color: color
    });
  ...
  if (['primary', 'secondary'].includes(fontFamily)) {
    attr.className = classnames$1(attr.className, style$i["font-".concat(fontFamily)]);
  }

  if (align) {
    attr.className = classnames$1(attr.className, style$i[align]);
  }

  return /*#__PURE__*/React__default["default"].createElement(as || variantToTags[variant] || variant, _objectSpread2$1(_objectSpread2$1({}, attr), {}, {
    children: children
  }));
};
...
Typography.propTypes = {
  className: T__default["default"].string,
  align: T__default["default"].oneOf(['left', 'center', 'right']),
  children: T__default["default"].oneOfType([T__default["default"].arrayOf(T__default["default"].node), T__default["default"].node]),
  variant: T__default["default"].oneOf(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'h7', 'body1', 'body2', 'subtitle1', 'subtitle2']),
  color: T__default["default"].string,
  fontFamily: T__default["default"].string,
  weight: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  as: T__default["default"].string
};
Typography.defaultProps = {
  variant: 'h1'
};

var style$h = {"root":"ethereans-interfaces_form-control_root"};
...
var FormControl = function FormControl(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("label", {
    className: classnames$1(style$h.root, className)
...
FormControl.propTypes = {
  className: T__default["default"].string,
  label: T__default["default"].string,
  control: T__default["default"].node
};

var style$g = {"root":"ethereans-interfaces_link_root"};

var _excluded$5 = ["children", "className", "external", "href", "to", "RLink"];
...
var Link = function Link(_ref) {
  ...
  var additionalProps = external && href ? {
    target: '_blank',
    rel: 'noreferrer'
  } : {};

  if (to) {
    return /*#__PURE__*/React__default["default"].createElement(RLink, _extends$g({
      to: to
    }, props, {
      className: classnames$1(style$g.root, className)
    }), children);
  }

  return /*#__PURE__*/React__default["default"].createElement("a", _extends$g({
    href: href
...
Link.propTypes = {
  className: T__default["default"].string,
  children: T__default["default"].oneOfType([T__default["default"].arrayOf(T__default["default"].node), T__default["default"].node]),
  href: T__default["default"].string,
  external: T__default["default"].bool,
  to: T__default["default"].string,
  RLink: T__default["default"].node
};

var style$f = {"root":"ethereans-interfaces_modal_root","centered":"ethereans-interfaces_modal_centered","centeredContainer":"ethereans-interfaces_modal_centeredContainer","fullWindow":"ethereans-interfaces_modal_fullWindow"};
...
var Modal = function Modal(_ref) {
  ...
  if (centered) {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      className: classnames$1(style$f.root, style$f.centeredContainer)
    }, /*#__PURE__*/React__default["default"].createElement("div", {
      className: classnames$1(style$f.centered, className)
    }, children));
  }

  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$f.root, style$f.fullWindow, className)
  }, children);
};
Modal.propTypes = {
  visible: T__default["default"].bool,
  children: T__default["default"].node,
  className: T__default["default"].string,
  centered: T__default["default"].bool
};

var style$e = {"root":"ethereans-interfaces_shinyText_root","always":"ethereans-interfaces_shinyText_always","hover":"ethereans-interfaces_shinyText_hover","animated":"ethereans-interfaces_shinyText_animated","shine":"ethereans-interfaces_shinyText_shine","strong":"ethereans-interfaces_shinyText_strong"};

var ShinyText = function ShinyText(_ref) {
  var _classNames;
  ...
  var text = _ref.text,
      ...
      className = _ref.className;
  return /*#__PURE__*/React__default["default"].createElement("span", {
    className: classnames$1(style$e.root, (_classNames = {}, _defineProperty$4(_classNames, style$e.always, !hover), _defineProperty$4(_classNames, style$e.animated, !!animated), _defineProperty$4(_classNames, style$e.hover, !!hover), _defineProperty$4(_classNames, style$e.strong, !!strong), _classNames), className)
  }, text);
};
ShinyText.propTypes = {
  text: T__default["default"].string.isRequired,
  hover: T__default["default"].bool,
  animated: T__default["default"].bool,
  strong: T__default["default"].bool,
  className: T__default["default"].string
};

var style$d = {"root":"ethereans-interfaces_table_root"};

function Table(_ref) {
  var cols = _ref.columns,
      rows = _ref.rows,
      tableClassName = _ref.tableClassName;
  return /*#__PURE__*/React__default["default"].createElement("table", {
    className: classnames$1(style$d.root, tableClassName)
  }, /*#__PURE__*/React__default["default"].createElement("thead", null, /*#__PURE__*/React__default["default"].createElement("tr", null, cols.map(function (c) {
  ...
  }))), /*#__PURE__*/React__default["default"].createElement("tbody", null, rows.map(function (r) {
    return /*#__PURE__*/React__default["default"].createElement("tr", {
      ...
      }, c.renderCell && r[c.field] ? /*#__PURE__*/React__default["default"].createElement(c.renderCell, {
        row: r,
        value: r[c.field]
      }) : /*#__PURE__*/React__default["default"].createElement(Typography, {
        variant: "body1"
...
Table.propTypes = {
  tableClassName: T__default["default"].string,
  rows: T__default["default"].arrayOf(T__default["default"].shape({
    id: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number])
  })).isRequired,
  columns: T__default["default"].arrayOf(T__default["default"].shape({
    field: T__default["default"].string,
    headerName: T__default["default"].string,
    renderCell: T__default["default"].func,
    flex: T__default["default"].number
  })).isRequired
};

var style$c = {"root":"ethereans-interfaces_textField_root","rounded":"ethereans-interfaces_textField_rounded","input":"ethereans-interfaces_textField_input","startContainer":"ethereans-interfaces_textField_startContainer","endContainer":"ethereans-interfaces_textField_endContainer"};

var _excluded$4 = ["className", "inputClassName", "onChange", "startComponent", "endComponent", "isMultiline", "isRounded"];
...
var TextField = function TextField(props) {
  ...
  var InputComponent = isMultiline ? 'textarea' : 'input';
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(className, style$c.root, isRounded && style$c.rounded)
  }, startComponent && /*#__PURE__*/React__default["default"].createElement("span", {
    className: style$c.startContainer
  }, startComponent), /*#__PURE__*/React__default["default"].createElement(InputComponent, _extends$g({
    onChange: onChange,
    className: classnames$1(inputClassName, style$c.input)
  }, otherProps)), endComponent && /*#__PURE__*/React__default["default"].createElement("span", {
    className: style$c.endContainer
  }, endComponent));
};

TextField.propTypes = {
  className: T__default["default"].string,
  isMultiline: T__default["default"].bool,
  isRounded: T__default["default"].bool,
  onChange: T__default["default"].func.isRequired,
  startComponent: T__default["default"].node,
  endComponent: T__default["default"].node,
  inputClassName: T__default["default"].string
};

var style$b = {"root":"ethereans-interfaces_tooltip_root"};

var ToolTip = function ToolTip(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$b.root, className)
  }, children);
};
ToolTip.propTypes = {
  children: T__default["default"].node,
...
var style$a = {"root":"ethereans-interfaces_linear-progress_root","primary":"ethereans-interfaces_linear-progress_primary","secondary":"ethereans-interfaces_linear-progress_secondary","lds-ellipsis1":"ethereans-interfaces_linear-progress_lds-ellipsis1","lds-ellipsis2":"ethereans-interfaces_linear-progress_lds-ellipsis2","lds-ellipsis3":"ethereans-interfaces_linear-progress_lds-ellipsis3"};

var LinearProgress = function LinearProgress(_ref) {
  var color = _ref.color,
      className = _ref.className;
  return /*#__PURE__*/React__default["default"].createElement("span", {
    className: classnames$1(style$a.root, style$a[color], className)
...
var style$9 = {"root":"ethereans-interfaces_circular-progress_root","spin":"ethereans-interfaces_circular-progress_spin","primary":"ethereans-interfaces_circular-progress_primary","secondary":"ethereans-interfaces_circular-progress_secondary","small":"ethereans-interfaces_circular-progress_small","medium":"ethereans-interfaces_circular-progress_medium","large":"ethereans-interfaces_circular-progress_large"};
...
var CircularProgress = function CircularProgress(_ref) {
  var size = _ref.size,
      ...
      className = _ref.className;
  return /*#__PURE__*/React__default["default"].createElement("span", {
    className: classnames$1(style$9.root, style$9[color], style$9[size], className)
  });
};
...
var style$8 = {"root":"ethereans-interfaces_token_root"};
...
var Token = function Token(_ref) {
  var className = _ref.className,
      ...
      logo = _ref.logo;
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$8.root, className)
  }, logo && /*#__PURE__*/React__default["default"].createElement("img", {
    src: "".concat(process.env.PUBLIC_URL, "/").concat(logo),
    alt: "token"
  }), symbol && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "h6",
    fontFamily: "primary"
  }, symbol));
};
...
Token.propTypes = {
  className: T__default["default"].string,
  logo: T__default["default"].string,
  symbol: T__default["default"].string
};
...
function z(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m:case e:case g:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case t:case r:case h:return a;default:return u}}case d:return u}}}function A(a){return z(a)===m}var AsyncMode=l;var ConcurrentMode=m;var ContextConsumer=k;var ContextProvider=h;var Element$1=c;var ForwardRef=n;var Fragment=e;var Lazy$1=t;var Memo=r;var Portal=d;
...
var hasOwnProperty$r = Object.prototype.hasOwnProperty;
...
var createEmotionProps = function createEmotionProps(type, props) {
  ...
  for (var key in props) {
    if (hasOwnProperty$r.call(props, key)) {
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  for (var key in props) {
    if (hasOwnProperty$r.call(props, key) && key !== 'css' && key !== typePropName && (process.env.NODE_ENV === 'production' || key !== labelPropName)) {
      newProps[key] = props[key];
    }
  }
...
var jsx = function jsx(type, props) {
  ...
  if (props == null || !hasOwnProperty$r.call(props, 'css')) {
    // $FlowFixMe
...
var _propTypes2 = _interopRequireDefault(T__default["default"]);
...
var IndicatorSeparator = function IndicatorSeparator(props) {
  var className = props.className,
      ...
      getStyles = props.getStyles,
      innerProps = props.innerProps;
  return jsx("span", _extends$f({}, innerProps, {
  ...
  _createClass$8(Select, [{
    ...
    function renderInput() {
      ...
      if (!isSearchable) {
        ...
        return /*#__PURE__*/React__default["default"].createElement(DummyInput, _extends$f({
          id: id,
      ...
      return /*#__PURE__*/React__default["default"].createElement(Input, _extends$f({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : /*#__PURE__*/React__default["default"].createElement(Placeholder, _extends$f({}, commonProps, {
          key: "placeholder",
          isDisabled: isDisabled,
          isFocused: isFocused
        }), placeholder);
      ...
      if (isMulti) {
        var selectValues = selectValue.map(function (opt, index) {
          ...
          return /*#__PURE__*/React__default["default"].createElement(MultiValue, _extends$f({}, commonProps, {
            components: {
      ...
      return /*#__PURE__*/React__default["default"].createElement(SingleValue, _extends$f({}, commonProps, {
        data: singleValue,
        isDisabled: isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(ClearIndicator, _extends$f({}, commonProps, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(LoadingIndicator, _extends$f({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return /*#__PURE__*/React__default["default"].createElement(IndicatorSeparator, _extends$f({}, commonProps, {
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(DropdownIndicator, _extends$f({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render(props, id) {
        ...
        return /*#__PURE__*/React__default["default"].createElement(Option, _extends$f({}, commonProps, {
          innerProps: innerProps,
          data: data,
          isDisabled: isDisabled,
          isSelected: isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function (item) {
          if (item.type === 'group') {
            ...
            return /*#__PURE__*/React__default["default"].createElement(Group, _extends$f({}, commonProps, {
              key: groupId,
              data: data,
              options: options,
      ...
      var menuElement = /*#__PURE__*/React__default["default"].createElement(MenuPlacer, _extends$f({}, commonProps, menuPlacementProps), function (_ref4) {
        var ref = _ref4.ref,
            _ref4$placerProps = _ref4.placerProps,
            placement = _ref4$placerProps.placement,
            maxHeight = _ref4$placerProps.maxHeight;
        return /*#__PURE__*/React__default["default"].createElement(Menu, _extends$f({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          return /*#__PURE__*/React__default["default"].createElement(MenuList, _extends$f({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/React__default["default"].createElement(MenuPortal, _extends$f({}, commonProps, {
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(LiveRegion, _extends$f({}, commonProps, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default["default"].createElement(SelectContainer, _extends$f({}, commonProps, {
        className: className,
        innerProps: {
          id: id,
        ...
        isDisabled: isDisabled,
        isFocused: isFocused
      }), this.renderLiveRegion(), /*#__PURE__*/React__default["default"].createElement(Control, _extends$f({}, commonProps, {
      ...
      }), /*#__PURE__*/React__default["default"].createElement(ValueContainer, _extends$f({}, commonProps, {
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/React__default["default"].createElement(IndicatorsContainer, _extends$f({}, commonProps, {
        isDisabled: isDisabled
  ...
  return _temp = _class = /*#__PURE__*/function (_Component) {
    ...
    _createClass$8(StateManager, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default["default"].createElement(SelectComponent, _extends$f({}, props, {
...
var SelectLibrary = index$1;

var style$7 = {"label":"ethereans-interfaces_select_label","image":"ethereans-interfaces_select_image"};

var Label = function Label(_ref) {
  var text = _ref.text,
      image = _ref.image;
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$7.label)
  }, image && /*#__PURE__*/React__default["default"].createElement("img", {
    src: image,
    alt: text,
    className: classnames$1(style$7.image)
  }), /*#__PURE__*/React__default["default"].createElement(Typography, {
    fontFamily: "primary",
    variant: "p",
    color: "primary"
...
Label.propTypes = {
  text: T__default["default"].string.isRequired,
  image: T__default["default"].any
};

var _excluded$3 = ["id", "containerClassName", "selectClassName", "onSelect", "options", "value", "showIcon"];
...
var Select = function Select(_ref) {
  ...
  }, [options]); // TODO All this should be done using the CSS
  ...
  var colourStyles = {
    option: function option(styles, _ref2) {
      ...
      return _objectSpread2$1(_objectSpread2$1({}, styles), {}, {
        backgroundColor: isDisabled ? null : isSelected ? hover : isFocused ? hover : null,
        color: isDisabled && '#464646',
        cursor: isDisabled ? 'not-allowed' : 'default',
        ':active': _objectSpread2$1(_objectSpread2$1({}, styles[':active']), {}, {
  ...
  }, /*#__PURE__*/React__default["default"].createElement(SelectLibrary, _extends$g({}, props, {
    value: options.find(function (o) {
      return o.id === value;
    }),
    className: classnames$1(selectClassName),
...
Select.propTypes = {
  containerClassName: T__default["default"].string,
  selectClassName: T__default["default"].string,
  id: T__default["default"].string.isRequired,
  onSelect: T__default["default"].func.isRequired,
  options: T__default["default"].arrayOf(T__default["default"].object).isRequired,
  value: T__default["default"].any.isRequired,
  showIcon: T__default["default"].bool
};

var style$6 = {"root":"ethereans-interfaces_snack-bar_root","error":"ethereans-interfaces_snack-bar_error","warning":"ethereans-interfaces_snack-bar_warning","success":"ethereans-interfaces_snack-bar_success"};
...
var SnackBar = function SnackBar(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$6.root, style$6[content.type])
  }, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1"
  }, content.message), /*#__PURE__*/React__default["default"].createElement(Link, {
    onClick: function onClick() {
      return setContent();
    }
  }, "Close"));
...
SnackBar.propTypes = {
  timeout: T__default["default"].number,
  setContent: T__default["default"].func.isRequired,
  content: T__default["default"].shape({
    type: T__default["default"].oneOf(['error', 'warning', 'success']),
    message: T__default["default"].string
  })
};

var style$5 = {"root":"ethereans-interfaces_connect-widget_root","rotateLogo":"ethereans-interfaces_connect-widget_rotateLogo","spin":"ethereans-interfaces_connect-widget_spin","button":"ethereans-interfaces_connect-widget_button","modalHeader":"ethereans-interfaces_connect-widget_modalHeader","retryButton":"ethereans-interfaces_connect-widget_retryButton"};

var ConnectWidget = function ConnectWidget(_ref) {
  var _wallet$error;

  var logo = _ref.logo,
      onClickConnect = _ref.onClickConnect,
      title = _ref.title,
      rotateLogo = _ref.rotateLogo,
      className = _ref.className,
  ...
  var _useState3 = React.useState({
    ...
    label: ''
      ...
      activeConnector = _useState4[0],
      setActiveConnector = _useState4[1];

  var onClick = function onClick() {
    setModalOpen(true);
    onClickConnect === null || onClickConnect === void 0 ? void 0 : onClickConnect();
  };

  var onConnectorClicked = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, label) {
    ...
    return function onConnectorClicked(_x, _x2) {
      return _ref2.apply(this, arguments);
    };
  }();

  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: classnames$1(style$5['root'], className)
  }, logo ? /*#__PURE__*/React__default["default"].createElement("img", {
    src: logo,
    alt: "logo",
    className: classnames$1(_defineProperty$4({}, style$5.rotateLogo, !!rotateLogo))
  }) : null, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "h1",
    color: "primary"
  }, title), /*#__PURE__*/React__default["default"].createElement("br", null), connectionStatus === interfacesCore.web3States.CONNECTED && /*#__PURE__*/React__default["default"].createElement("div", null, "Connected"), connectionStatus === interfacesCore.web3States.CONNECTING && /*#__PURE__*/React__default["default"].createElement("div", null, "Connecting"), connectionStatus === interfacesCore.web3States.NOT_CONNECTED && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Button, {
    onClick: onClick,
    text: "Connect",
    variant: "primary"
  }), /*#__PURE__*/React__default["default"].createElement("br", null), /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body2",
    align: "center"
  }, "You need a", ' ', /*#__PURE__*/React__default["default"].createElement("a", {
    href: "https://etherscan.io/directory/Wallet"
  }, "Web3 Enabler"), " to use this Dapp - If you have problems connecting, refresh the page.")), /*#__PURE__*/React__default["default"].createElement(Modal, {
    centered: true,
    visible: !!modalOpen
  }, /*#__PURE__*/React__default["default"].createElement("div", {
    className: style$5.modalHeader
  }, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "h5"
  }, activeConnector.label || 'Connect to a wallet'), /*#__PURE__*/React__default["default"].createElement(Button, {
  ...
  })), activeConnector.name && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, wallet.status === 'connecting' && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1"
  }, "Connecting to ", activeConnector.label, " ", /*#__PURE__*/React__default["default"].createElement(CircularProgress, null)), wallet.status === 'error' && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1"
  }, (_wallet$error = wallet.error) === null || _wallet$error === void 0 ? void 0 : _wallet$error.message), /*#__PURE__*/React__default["default"].createElement(Button, {
    className: style$5.retryButton,
    onClick: function onClick() {
      wallet.reset();
      wallet.connect(activeConnector.name);
    },
    text: "Retry"
  })), wallet.status === 'connected' && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1"
  }, "You've been correctly connected")), !activeConnector.name && connectors.map(function (connector) {
    return /*#__PURE__*/React__default["default"].createElement(Button, {
      key: connector.id,
      className: style$5.button,
      text: connector.buttonText,
      onClick: function onClick() {
        return onConnectorClicked(connector.id, connector.buttonText);
      }
    });
  })));
};
...
ConnectWidget.propTypes = {
  logo: T__default["default"].string,
  onClickConnect: T__default["default"].func,
  connectionStatus: T__default["default"].string.isRequired,
  title: T__default["default"].string,
  className: T__default["default"].string,
  connectError: T__default["default"].string,
  rotateLogo: T__default["default"].bool,
  wallet: T__default["default"].shape({
    networkName: T__default["default"].string,
    connect: T__default["default"].func.isRequired,
    status: T__default["default"].oneOf(['disconnected', 'connecting', 'connected', 'error']).isRequired,
    error: T__default["default"].shape({
      name: T__default["default"].string,
      message: T__default["default"].string
    }),
    reset: T__default["default"].func.isRequired
  }).isRequired,
  connectors: T__default["default"].arrayOf(T__default["default"].shape({
    id: T__default["default"].string,
    buttonText: T__default["default"].string
  }))
};
...
function isPlainObject$1(value) {
  if (!isObjectLike$1(value) || baseGetTag$1(value) != objectTag$9) {
    return false;
  }
...
var reIsNative$1 = RegExp('^' +
  funcToString$3.call(hasOwnProperty$o).replace(reRegExpChar$1, '\\$&')
...
var isArguments$1 = baseIsArguments$1(function() { return arguments; }()) ? baseIsArguments$1 : function(value) {
  return isObjectLike$1(value) && hasOwnProperty$k.call(value, 'callee') &&
...
typedArrayTags$1[mapTag$b] = typedArrayTags$1[numberTag$7] =
typedArrayTags$1[objectTag$8] = typedArrayTags$1[regexpTag$7] =
typedArrayTags$1[setTag$b] = typedArrayTags$1[stringTag$8] =
...
function baseKeysIn$1(object) {
  ...
  for (var key in object) {
    if (!(key == 'constructor' && (isProto || !hasOwnProperty$h.call(object, key)))) {
      result.push(key);
    }
  }
  return result;
...
var getSymbolsIn$2 = getSymbolsIn$1;
...
function copySymbolsIn$1(source, object) {
  return copyObject$1(source, getSymbolsIn$2(source), object);
}
...
function getAllKeysIn$1(object) {
  return baseGetAllKeys$1(object, keysIn$1, getSymbolsIn$2);
}
...
if ((DataView$2 && getTag$1(new DataView$2(new ArrayBuffer(1))) != dataViewTag$8) ||
    (Map$3 && getTag$1(new Map$3) != mapTag$a) ||
    (Promise$3 && getTag$1(Promise$3.resolve()) != promiseTag$1) ||
    (Set$3 && getTag$1(new Set$3) != setTag$a) ||
    (WeakMap$3 && getTag$1(new WeakMap$3) != weakMapTag$4)) {
...
var symbolProto$5 = Symbol$3 ? Symbol$3.prototype : undefined,
...
function baseIsMap$1(value) {
  return isObjectLike$1(value) && getTag$2(value) == mapTag$8;
}
...
function baseIsSet$1(value) {
  return isObjectLike$1(value) && getTag$2(value) == setTag$8;
}
...
cloneableTags$1[stringTag$6] = cloneableTags$1[symbolTag$6] =
...
function isSymbol$1(value) {
  return typeof value == 'symbol' ||
    (isObjectLike$1(value) && baseGetTag$1(value) == symbolTag$5);
}
...
function toPath(value) {
  ...
  return isSymbol$1(value) ? [value] : copyArray$1(stringToPath$2(toString$2(value)));
}
...
var isNaN$1$1 = function isNaN(obj) {
  return obj !== obj;
};
...
function formikReducer(state, msg) {
  switch (msg.type) {
    ...
    case 'RESET_FORM':
      return _extends$e({}, state, msg.payload);
...
function useField(propsOrFieldName) {
  ...
  var isAnObject = isObject$2(propsOrFieldName); // Normalize propsOrFieldName to FieldHookConfig<Val>
...
function Field(_ref) {
  ...
  var field = formik.getFieldProps(_extends$e({
    name: name
  }, props));
  ...
  if (render) {
    return render(_extends$e({}, legacyBag, {
      meta: meta
    }));
  }

  if (isFunction$1(children)) {
    return children(_extends$e({}, legacyBag, {
      meta: meta
    }));
  }
  ...
  if (component) {
    ...
    if (typeof component === 'string') {
      ...
      return React.createElement(component, _extends$e({
        ref: innerRef
      }, field, rest), children);
  ...
  if (typeof asElement === 'string') {
    ...
    return React.createElement(asElement, _extends$e({
      ref: _innerRef
    }, field, _rest), children);
  }

  return React.createElement(asElement, _extends$e({}, field, props), children);
}
...
function withFormik(_ref) {
  var _ref$mapPropsToValues = _ref.mapPropsToValues,
    ...
    return val;
      ...
      config = _objectWithoutPropertiesLoose$1(_ref, ["mapPropsToValues"]);
    ...
    var C = /*#__PURE__*/function (_React$Component) {
      ...
      function C() {
        ...
        _this.handleSubmit = function (values, actions) {
          return config.handleSubmit(values, _extends$e({}, actions, {
            props: _this.props
          }));
        };
        /**
        ...
        _this.renderFormComponent = function (formikProps) {
          return React.createElement(Component$1, Object.assign({}, _this.props, formikProps));
        };
      ...
      _proto.render = function render() {
        var _this$props = this.props,
            props = _objectWithoutPropertiesLoose$1(_this$props, ["children"]);
...
var copyArrayLike = function copyArrayLike(arrayLike) {
  if (!arrayLike) {
    ...
    return Array.from(_extends$e({}, arrayLike, {
      length: maxIndex + 1
    }));
  }
};
...
var FieldArrayInner = /*#__PURE__*/function (_React$Component) {
  ...
  function FieldArrayInner(props) {
    ...
    _this.push = function (value) {
      return _this.updateArrayField(function (arrayLike) {
        return [].concat(copyArrayLike(arrayLike), [cloneDeep$1(value)]);
      }, false, false);
    };
  ...
  _proto.render = function render() {
    ...
    var props = _extends$e({}, arrayHelpers, {
      form: restOfFormik,
      name: name
    });
...
var FastFieldInner = /*#__PURE__*/function (_React$Component) {
  ...
  function FastFieldInner(props) {
    ...
    var render = props.render,
        ...
        is = props.as,
        name = props.name;
    !!render ? process.env.NODE_ENV !== "production" ? warning(false, "<FastField render> has been deprecated. Please use a child callback function instead: <FastField name={" + name + "}>{props => ...}</FastField> instead.") : warning(false) : void 0;
    !!(component && render) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField component> and <FastField render> in the same <FastField> component; <FastField component> will be ignored') : warning(false) : void 0;
    !!(is && children && isFunction$1(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField as> and <FastField children> as a function in the same <FastField> component; <FastField as> will be ignored.') : warning(false) : void 0;
    !!(component && children && isFunction$1(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField component> and <FastField children> as a function in the same <FastField> component; <FastField component> will be ignored.') : warning(false) : void 0;
    !!(render && children && !isEmptyChildren(children)) ? process.env.NODE_ENV !== "production" ? warning(false, 'You should not use <FastField render> and <FastField children> in the same <FastField> component; <FastField children> will be ignored') : warning(false) : void 0;
    return _this;
  }
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(props) {
    ...
    } else if (props.name !== this.props.name || getIn$1(props.formik.values, this.props.name) !== getIn$1(this.props.formik.values, this.props.name) || getIn$1(props.formik.errors, this.props.name) !== getIn$1(this.props.formik.errors, this.props.name) || getIn$1(props.formik.touched, this.props.name) !== getIn$1(this.props.formik.touched, this.props.name) || Object.keys(this.props).length !== Object.keys(props).length || props.formik.isSubmitting !== this.props.formik.isSubmitting) {
      return true;
    } else {
      return false;
    }
  ...
  _proto.render = function render() {
    var _this$props = this.props,
        ...
        component = _this$props.component,
        formik = _this$props.formik,
        props = _objectWithoutPropertiesLoose$1(_this$props, ["validate", "name", "render", "as", "children", "component", "shouldUpdate", "formik"]);
    ...
    var meta = {
      value: getIn$1(formik.values, name),
      error: getIn$1(formik.errors, name),
      touched: !!getIn$1(formik.touched, name),
      initialValue: getIn$1(formik.initialValues, name),
      initialTouched: !!getIn$1(formik.initialTouched, name),
      initialError: getIn$1(formik.initialErrors, name)
    };
    var bag = {
      field: field,
      meta: meta,
...
var style$4 = {"root":"ethereans-interfaces_token-picker_root"};

var _excluded$2 = ["onChange"];

var TokenPicker = function TokenPicker(_ref) {
  ...
  var _useField = useField({
    ...
    name: name
      ...
      _useField2$.onChange;
      var field = _objectWithoutProperties$1(_useField2$, _excluded$2);

  var _useFormikContext = useFormikContext(),
      setFieldValue = _useFormikContext.setFieldValue;

  var uniswapPairs = interfacesCore.useLoadUniswapPairs(tokenAddress);
  var options = React.useMemo(function () {
    return uniswapPairs.map(function (pair) {
      var _pair$token, _pair$token2;

      return {
        id: (pair === null || pair === void 0 ? void 0 : (_pair$token = pair.token1) === null || _pair$token === void 0 ? void 0 : _pair$token.address) || pair.address,
        label: pair !== null && pair !== void 0 && (_pair$token2 = pair.token1) !== null && _pair$token2 !== void 0 && _pair$token2.name ? "".concat(pair.token1.name, " (").concat(pair.token1.symbol, ")") : pair.symbol
      };
    });
  }, [uniswapPairs]);
  return /*#__PURE__*/React__default["default"].createElement(Select, _extends$g({
    id: "token",
    name: "token",
    options: options,
    valueKey: "token",
    containerClassName: style$4.root
  }, field, {
...
TokenPicker.propTypes = {
  tokenAddress: T__default["default"].string,
  id: T__default["default"].string,
  name: T__default["default"].string
};
...
class ValidationError extends Error {
  static formatError(message, params) {
    ...
    if (path !== params.path) params = _extends$d({}, params, {
      path
    });
...
typedArrayTags[argsTag$3] = typedArrayTags[arrayTag$3] =
typedArrayTags[arrayBufferTag$4] = typedArrayTags[boolTag$4] =
typedArrayTags[dataViewTag$5] = typedArrayTags[dateTag$4] =
typedArrayTags[errorTag$3] = typedArrayTags[funcTag$1] =
typedArrayTags[mapTag$6] = typedArrayTags[numberTag$4] =
typedArrayTags[objectTag$5] = typedArrayTags[regexpTag$4] =
typedArrayTags[setTag$6] = typedArrayTags[stringTag$5] =
...
function equalArrays$1(array, other, bitmask, customizer, equalFunc, stack) {
  ...
  var index = -1,
      result = true,
      seen = (bitmask & COMPARE_UNORDERED_FLAG$7) ? new _SetCache : undefined;
...
function baseIsMatch$1(object, source, matchData, customizer) {
  ...
  while (++index < length) {
    ...
    if (noCustomizer && data[2]) {
      ...
      if (!(result === undefined
            ? _baseIsEqual(srcValue, objValue, COMPARE_PARTIAL_FLAG$7 | COMPARE_UNORDERED_FLAG$5, customizer, stack)
            : result
          )) {
        return false;
      }
...
function baseMatchesProperty$1(path, srcValue) {
  ...
  return function(object) {
    ...
    return (objValue === undefined && objValue === srcValue)
      ? hasIn_1(object, path)
      : _baseIsEqual(srcValue, objValue, COMPARE_PARTIAL_FLAG$6 | COMPARE_UNORDERED_FLAG$4);
  };
}
...
function createValidation(config) {
  function validate(_ref, cb) {
    ...
    function createError(overrides = {}) {
      const nextParams = mapValues_1(_extends$c({
        value,
        originalValue,
        label,
...
class BaseSchema {
  ...
  clone(spec) {
    ...
    next.exclusiveTests = _extends$b({}, this.exclusiveTests); // @ts-expect-error this is readonly

    next.deps = [...this.deps];
    next.conditions = [...this.conditions];
    next.tests = [...this.tests];
    next.transforms = [...this.transforms];
    next.spec = clone(_extends$b({}, this.spec, spec));
    return next;
  }
  ...
  concat(schema) {
    ...
    const mergedSpec = _extends$b({}, base.spec, combined.spec); // if (combined.spec.nullable === UNSET)
  ...
  cast(value, options = {}) {
    let resolvedSchema = this.resolve(_extends$b({
      value
    }, options));
  ...
  _validate(_value, options = {}, cb) {
    ...
    if (!strict) {
      ...
      value = this._cast(value, _extends$b({
        assert: false
  ...
  validate(value, options, maybeCb) {
    let schema = this.resolve(_extends$b({}, options, {
      value
  ...
  validateSync(value, options) {
    ...
    schema._validate(value, _extends$b({}, options, {
      sync: true
    }), (err, value) => {
      if (err) throw err;
      result = value;
...
for (const method of ['validate', 'validateSync']) BaseSchema.prototype[`${method}At`] = function (path, value, options = {}) {
  ...
  return schema[method](parent && parent[parentPath], _extends$b({}, options, {
    parent,
    path
  }));
};
...
class ObjectSchema extends BaseSchema {
  ...
  _cast(_value, options = {}) {
    ...
    let innerOptions = _extends$a({}, options, {
    ...
    super._validate(_value, opts, (err, value) => {
      ...
      let tests = this._nodes.map(key => (_, cb) => {
        ...
        if (field && 'validate' in field) {
          field.validate(value[key], _extends$a({}, opts, {
            // @ts-ignore
            path,
            from,
  ...
  clone(spec) {
    ...
    next.fields = _extends$a({}, this.fields);
...
class ArraySchema extends BaseSchema {
  ...
  _cast(_value, _opts) {
    ...
    const castArray = value.map((v, idx) => {
      const castElement = this.innerType.cast(v, _extends$9({}, _opts, {
        path: `${_opts.path || ''}[${idx}]`
      }));
  ...
  _validate(_value, options = {}, callback) {
    ...
    super._validate(_value, options, (err, value) => {
      ...
      for (let idx = 0; idx < value.length; idx++) {
        ...
        let innerOptions = _extends$9({}, options, {
          path,
          strict: true,
          parent: value,
          index: idx,
...
var style$3 = {"header":"ethereans-interfaces_edit-field_header","inputContainer":"ethereans-interfaces_edit-field_inputContainer","tooltip":"ethereans-interfaces_edit-field_tooltip","inputWrapper":"ethereans-interfaces_edit-field_inputWrapper"};

var _excluded$1 = ["label", "description", "id", "name", "RightInputComponent"];
...
addMethod(create$5, 'isValidUrl', function () {
  return this.test({
    name: 'isValidUrl',
...
var EditField = function EditField(_ref) {
  var label = _ref.label,
      ...
      id = _ref.id,
      name = _ref.name,
      RightInputComponent = _ref.RightInputComponent,
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: style$3.inputWrapper
  }, /*#__PURE__*/React__default["default"].createElement(TextField, _extends$g({
    className: style$3.inputContainer
  }, field, props)), RightInputComponent && RightInputComponent)), description && /*#__PURE__*/React__default["default"].createElement(ToolTip, {
    className: style$3.tooltip
  }, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body2"
  }, description)));
};
EditField.propTypes = {
  ...
  name: T__default["default"].string,
  label: T__default["default"].string,
  description: T__default["default"].string,
  RightInputComponent: T__default["default"].node
};

var validationSwapSchema = create$2().shape({
  amount: create$4().min(0, 'The amount has to be more than 0').required('The amount is required'),
  token: create$5().required('The token is required').nullable()
});
var validationTransferSchema = create$2().shape({
  amount: create$4().min(0, 'The amount has to be more than 0').required('The amount is required'),
  address: create$5().required('The address is required')
});

var style$2 = {"root":"ethereans-interfaces_balance_root","token":"ethereans-interfaces_balance_token","amount":"ethereans-interfaces_balance_amount","actions":"ethereans-interfaces_balance_actions","transfer":"ethereans-interfaces_balance_transfer","swap":"ethereans-interfaces_balance_swap","submitButton":"ethereans-interfaces_balance_submitButton"};
...
var Swap = function Swap(_ref) {
  var token = _ref.token,
      onSwapSubmit = _ref.onSwapSubmit;

  var _useWeb = interfacesCore.useWeb3(),
      wethAddress = _useWeb.wethAddress;

  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: style$2.swap
  }, /*#__PURE__*/React__default["default"].createElement(Formik, {
    initialValues: initialValues$1,
    validationSchema: validationSwapSchema,
    onSubmit: onSwapSubmit
  }, function (_ref2) {
    var isValid = _ref2.isValid,
        errors = _ref2.errors;
    return /*#__PURE__*/React__default["default"].createElement(Form, null, /*#__PURE__*/React__default["default"].createElement(Typography, {
      variant: "body1"
    }, "Propose to swap:"), /*#__PURE__*/React__default["default"].createElement(EditField, {
      id: "amount",
      name: "amount",
      type: "number",
      min: "0",
      step: 0.000000001,
      RightInputComponent: /*#__PURE__*/React__default["default"].createElement(Token, {
        symbol: token.symbol
      })
    }), /*#__PURE__*/React__default["default"].createElement(Typography, {
      variant: "body1"
    }, "For:"), /*#__PURE__*/React__default["default"].createElement(TokenPicker, {
      id: "token",
      name: "token",
      tokenAddress: token.address === interfacesCore.VOID_ETHEREUM_ADDRESS ? wethAddress : token.address
    }), errors.amount || errors.token ? /*#__PURE__*/React__default["default"].createElement(Typography, {
      color: "secondary",
      variant: "subtitle1"
    }, errors.amount || errors.token) : null, /*#__PURE__*/React__default["default"].createElement(Button, {
      type: "submit",
      disabled: !isValid,
      className: style$2.submitButton,
      text: "SWAP",
      size: "small"
    }));
  }));
...
Swap.propTypes = {
  onSwap: T__default["default"].func.isRequired,
  token: T__default["default"].object.isRequired,
  organization: T__default["default"].object,
  onSwapSubmit: T__default["default"].func
};
...
var Transfer = function Transfer(_ref) {
  var onTransferSubmit = _ref.onTransferSubmit,
      token = _ref.token;
  return /*#__PURE__*/React__default["default"].createElement("div", {
    className: style$2.transfer
  }, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1",
    fontFamily: "primary"
  }, /*#__PURE__*/React__default["default"].createElement(Formik, {
    initialValues: initialValues,
    validationSchema: validationTransferSchema,
    ...
    return /*#__PURE__*/React__default["default"].createElement(Form, null, /*#__PURE__*/React__default["default"].createElement(Typography, {
      variant: "body1"
    }, "Propose to transfer:"), /*#__PURE__*/React__default["default"].createElement(EditField, {
      id: "amount",
      name: "amount",
      type: "number",
      min: "0",
      ...
      variant: "p"
    }, "To:"), /*#__PURE__*/React__default["default"].createElement(EditField, {
      id: "address",
      name: "address"
    }), (errors.amount || errors.token) && /*#__PURE__*/React__default["default"].createElement(Typography, {
      color: "secondary",
      variant: "subtitle1"
    }, errors.amount || errors.token), /*#__PURE__*/React__default["default"].createElement(Button, {
      type: "submit",
      disabled: !isValid,
      className: style$2.submitButton,
      text: "TRANSFER",
...
Transfer.propTypes = {
  onTransferSubmit: T__default["default"].func.isRequired,
  token: T__default["default"].object.isRequired
};
...
var Balance = function Balance(_ref) {
  var className = _ref.className,
      ...
      onTransferSubmit = _ref.onTransferSubmit,
      onSwapSubmit = _ref.onSwapSubmit;

  var _useState = React.useState(false),
      _useState2 = _slicedToArray(_useState, 2),
      isSwap = _useState2[0],
      setIsSwap = _useState2[1];

  var _useState3 = React.useState(false),
      _useState4 = _slicedToArray(_useState3, 2),
      isTransfer = _useState4[0],
      setIsTransfer = _useState4[1];

  if (!tokenAmount || tokenAmount === '0') return null;
  return /*#__PURE__*/React__default["default"].createElement(Card, {
    className: classnames$1(style$2.root, className)
  }, /*#__PURE__*/React__default["default"].createElement("div", {
    className: style$2.token
  }, /*#__PURE__*/React__default["default"].createElement(Token, {
    symbol: token.symbol,
    logo: token.logo
  }), !!tokenPrice && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body1",
    fontFamily: "primary"
  }, "($", tokenPrice, ")")), !!tokenAmount && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "h5",
    weight: "bold",
    fontFamily: "primary"
  }, tokenAmount), showActions && /*#__PURE__*/React__default["default"].createElement("div", {
    className: style$2.actions
  ...
  })), isSwap && /*#__PURE__*/React__default["default"].createElement(Swap, {
    token: token,
    onSwapSubmit: onSwapSubmit
  }), isTransfer && /*#__PURE__*/React__default["default"].createElement(Transfer, {
...
Balance.propTypes = {
  className: T__default["default"].string,
  showActions: T__default["default"].bool,
  token: T__default["default"].shape({
    symbol: T__default["default"].string,
    logo: T__default["default"].string
  }).isRequired,
  tokenPrice: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  tokenAmount: T__default["default"].string,
  onSwapSubmit: T__default["default"].func,
  onTransferSubmit: T__default["default"].func
};

var style$1 = {"header":"ethereans-interfaces_file-field_header","inputContainer":"ethereans-interfaces_file-field_inputContainer","tooltip":"ethereans-interfaces_file-field_tooltip"};

var _excluded = ["label", "description", "id", "name", "isImage"],
    _excluded2 = ["value"];

function checkCoverSize(_x) {
  return _checkCoverSize.apply(this, arguments);
}

function _checkCoverSize() {
  _checkCoverSize = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(file) {
    var cover;
...
addMethod(create$7, 'fileSizeMax', function (max) {
  return this.test({
    name: 'fileSizeMax',
...
addMethod(create$7, 'imageMaxWidth', function (maxWidth) {
  return this.test({
    name: 'imageMaxWidth',
    message: "The max image with is ".concat(maxWidth),
    params: {
      maxWidth: maxWidth
    },
    test: function () {
      var _test = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(file) {
        var image;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                _context.next = 4;
                return checkCoverSize(file);

              case 4:
                image = _context.sent;
                return _context.abrupt("return", image.width < maxWidth);
...
addMethod(create$7, 'imageMaxMBSize', function (maxMBSize) {
  return this.test({
    name: 'imageMaxMBSize',
    message: "The max image size inn Mb is ".concat(maxMBSize),
    params: {
      maxMBSize: maxMBSize
    },
    test: function () {
      var _test2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(file) {
        var image;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                return _context2.abrupt("return", image.mBLength < maxMBSize);
...
var FileField = function FileField(_ref) {
  ...
  var value = field.value,
      rest = _objectWithoutProperties$1(field, _excluded2);
  ...
  return /*#__PURE__*/React__default["default"].createElement("section", null, /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: "button",
    color: "tertiary"
  }), /*#__PURE__*/React__default["default"].createElement("input", _extends$g({
    type: "file",
    ref: hiddenFileInput,
    style: {
      display: 'none'
    ...
    onChange: handleChange
  }))), (value === null || value === void 0 ? void 0 : value.name) && /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body2"
  }, " ", value === null || value === void 0 ? void 0 : value.name), touched && error ? error : '', description && /*#__PURE__*/React__default["default"].createElement(ToolTip, {
    className: style$1.tooltip
  }, /*#__PURE__*/React__default["default"].createElement(Typography, {
    variant: "body2"
  }, description)));
};
FileField.propTypes = {
  ...
  label: T__default["default"].string,
  description: T__default["default"].string,
  isImage: T__default["default"].bool
};
 ...
 */
var baseEach$2 = _createBaseEach(_baseForOwn);
...
var Checkboard = function Checkboard(_ref) {
  ...
  return React.isValidElement(children) ? React__default["default"].cloneElement(children, _extends$8({}, children.props, { style: _extends$8({}, children.props.style, styles.grid) })) : React__default["default"].createElement('div', { style: styles.grid });
};
    ...
    value: function render() {
      ...
      return React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement(Checkboard, { renderers: this.props.renderers })
        ),
        React__default["default"].createElement('div', { style: styles.gradient }),
        React__default["default"].createElement(
          'div',
          {
          ...
          React__default["default"].createElement(
            ...
            this.props.pointer ? React__default["default"].createElement(this.props.pointer, this.props) : React__default["default"].createElement('div', { style: styles.slider })
          )
        )
      );
    }
  ...
  _createClass$6(EditableInput, [{
    ...
    value: function render() {
      ...
      return React__default["default"].createElement(
        ...
        this.props.label && !this.props.hideLabel ? React__default["default"].createElement(
          'label',
          {
...
var Raised = function Raised(_ref) {
  ...
  return React__default["default"].createElement(
    'div',
    { style: styles.wrap },
    React__default["default"].createElement('div', { style: styles.bg }),
    React__default["default"].createElement(
      'div',
...
Raised.propTypes = {
  background: T__default["default"].string,
  zDepth: T__default["default"].oneOf([0, 1, 2, 3, 4, 5]),
  radius: T__default["default"].number,
  styles: T__default["default"].object
};
    ...
    value: function render() {
      ...
      return React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement('div', { style: styles.black, className: 'saturation-black' }),
          React__default["default"].createElement(
            'div',
            { style: styles.pointer },
            this.props.pointer ? React__default["default"].createElement(this.props.pointer, this.props) : React__default["default"].createElement('div', { style: styles.circle })
          )
        )
      );
    }
  ...
  var ColorPicker = function (_ref) {
    ...
    _createClass$3(ColorPicker, [{
      ...
      value: function render() {
        ...
        return React__default["default"].createElement(Picker, _extends$6({}, this.props, this.state, {
          onChange: this.handleChange
        }, optionalEvents));
      }
    }], [{
    ...
    _createClass$2(Focus, [{
      ...
      value: function render() {
        return React__default["default"].createElement(
          ...
          React__default["default"].createElement(Component, _extends$5({}, this.props, this.state))
        );
      }
    }]);
...
var Swatch = function Swatch(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    children,
    transparent && React__default["default"].createElement(Checkboard, {
...
var AlphaPointer = function AlphaPointer(_ref) {
  ...
  return React__default["default"].createElement('div', { style: styles.picker });
};
...
var AlphaPicker = function AlphaPicker(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(Alpha, _extends$3({}, styles.alpha, {
      rgb: rgb,
      hsl: hsl,
      pointer: pointer,
      renderers: renderers,
...
function castPath(value, object) {
  ...
  return isKey(value, object) ? [value] : stringToPath$2(toString$2(value));
}
...
var BlockSwatches = function BlockSwatches(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    map(colors, function (c) {
      return React__default["default"].createElement(Swatch$1, {
        key: c,
        color: c,
        style: styles.swatch,
        onClick: onClick,
    ...
    React__default["default"].createElement('div', { style: styles.clear })
  );
};
...
var Block = function Block(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement('div', { style: styles.triangle }),
    React__default["default"].createElement(
      'div',
      { style: styles.head },
      transparent && React__default["default"].createElement(Checkboard, { borderRadius: '6px 6px 0 0' }),
      React__default["default"].createElement(
        'div',
        { style: styles.label },
        hex
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.body },
      React__default["default"].createElement(BlockSwatches, { colors: colors, onClick: handleChange, onSwatchHover: onSwatchHover }),
      React__default["default"].createElement(EditableInput, {
...
Block.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  colors: T__default["default"].arrayOf(T__default["default"].string),
  triangle: T__default["default"].oneOf(['top', 'hide']),
  styles: T__default["default"].object
};
...
var CircleSwatch = function CircleSwatch(_ref) {
  ...
  return React__default["default"].createElement(
    'div',
    { style: styles.swatch },
    React__default["default"].createElement(Swatch$1, {
      style: styles.Swatch,
      color: color,
      onClick: onClick,
      onHover: onSwatchHover,
...
var Circle = function Circle(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    map(colors, function (c) {
      return React__default["default"].createElement(CircleSwatch$1, {
        key: c,
        color: c,
...
Circle.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  circleSize: T__default["default"].number,
  circleSpacing: T__default["default"].number,
  styles: T__default["default"].object
};
  ...
  _createClass$1(ChromeFields, [{
    ...
    value: function render() {
      ...
      if (this.state.view === 'hex') {
        fields = React__default["default"].createElement(
          'div',
      ...
      return React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement(
            ...
            React__default["default"].createElement(UnfoldMoreHorizontalIcon$1, {
              style: styles.svg,
...
var Chrome = function Chrome(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(Saturation, {
        style: styles.Saturation,
        hsl: hsl,
        hsv: hsv,
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          React__default["default"].createElement(
            'div',
            { style: styles.swatch },
            React__default["default"].createElement('div', { style: styles.active }),
            React__default["default"].createElement(Checkboard, { renderers: renderers })
          )
        ),
        React__default["default"].createElement(
          'div',
      ...
      React__default["default"].createElement(ChromeFields, {
        rgb: rgb,
        hsl: hsl,
        hex: hex,
        view: defaultView,
...
Chrome.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  disableAlpha: T__default["default"].bool,
  styles: T__default["default"].object,
  defaultView: T__default["default"].oneOf(["hex", "rgb", "hsl"])
};
...
var CompactColor = function CompactColor(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement('div', { style: styles.dot })
  );
};
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        ...
        null,
        map(colors, function (c) {
          return React__default["default"].createElement(CompactColor, {
            key: c,
            color: c,
      ...
      React__default["default"].createElement(CompactFields, { hex: hex, rgb: rgb, onChange: handleChange })
    )
  );
};
...
var Github = function Github(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement('div', { style: styles.triangleShadow }),
    React__default["default"].createElement('div', { style: styles.triangle }),
    map(colors, function (c) {
      return React__default["default"].createElement(GithubSwatch$1, {
        color: c,
        key: c,
        onClick: handleChange,
        onSwatchHover: onSwatchHover
...
Github.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  colors: T__default["default"].arrayOf(T__default["default"].string),
  triangle: T__default["default"].oneOf(['hide', 'top-left', 'top-right', 'bottom-left', 'bottom-right']),
  styles: T__default["default"].object
};
...
var HuePicker = function HuePicker(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(Hue, _extends$2({}, styles.hue, {
      hsl: hsl,
      pointer: pointer,
      onChange: handleChange,
      direction: direction
...
var PhotoshopPicker = function PhotoshopPicker(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement('div', { style: styles.divider }),
    React__default["default"].createElement(EditableInput, {
      style: { wrap: styles.RGBwrap, input: styles.RGBinput, label: styles.RGBlabel },
      label: 'r',
      value: rgb.r,
...
var PhotoshopPointerCircle = function PhotoshopPointerCircle() {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.left },
      React__default["default"].createElement('div', { style: styles.leftInside })
    ),
    React__default["default"].createElement(
      'div',
      { style: styles.right },
      React__default["default"].createElement('div', { style: styles.rightInside })
    )
  );
};
...
var PhotoshopPreviews = function PhotoshopPreviews(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.swatches },
      React__default["default"].createElement('div', { style: styles.new }),
      React__default["default"].createElement('div', { style: styles.current })
    ),
    React__default["default"].createElement(
      'div',
      { style: styles.label },
          ...
          React__default["default"].createElement(
            ...
            React__default["default"].createElement(
              ...
              React__default["default"].createElement(
                ...
                React__default["default"].createElement(PhotoshopPreviews, {
                  rgb: this.props.rgb,
              ...
              React__default["default"].createElement(
                ...
                React__default["default"].createElement(PhotoshopButton, { label: 'OK', onClick: this.props.onAccept, active: true }),
                React__default["default"].createElement(PhotoshopButton, { label: 'Cancel', onClick: this.props.onCancel }),
                React__default["default"].createElement(PhotoshopPicker, {
                  onChange: this.props.onChange,
                  rgb: this.props.rgb,
                  hsv: this.props.hsv,
                  hex: this.props.hex
...
Photoshop.propTypes = {
  header: T__default["default"].string,
  styles: T__default["default"].object
};
  ...
  return React__default["default"].createElement(
    ...
    colors.map(function (colorObjOrString) {
      ...
      return React__default["default"].createElement(
        ...
        React__default["default"].createElement(Swatch$1, _extends$1({}, c, {
          style: styles.swatch,
          onClick: handleClick,
          onHover: onSwatchHover,
          focusStyle: {
...
SketchPresetColors.propTypes = {
  colors: T__default["default"].arrayOf(T__default["default"].oneOfType([T__default["default"].string, T__default["default"].shape({
    color: T__default["default"].string,
    title: T__default["default"].string
  })])).isRequired
};
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(
        'div',
        { style: styles.color },
        React__default["default"].createElement(Checkboard, null),
        React__default["default"].createElement('div', { style: styles.activeColor })
      )
    ),
    React__default["default"].createElement(SketchFields, {
      rgb: rgb,
      hsl: hsl,
      hex: hex,
      onChange: onChange,
    ...
    React__default["default"].createElement(SketchPresetColors, {
      colors: presetColors,
      onClick: onChange,
      onSwatchHover: onSwatchHover
    })
...
var SliderSwatch = function SliderSwatch(_ref) {
  ...
  return React__default["default"].createElement('div', { style: styles.swatch, onClick: handleClick });
};
...
var SliderSwatches = function SliderSwatches(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.swatch },
      React__default["default"].createElement(SliderSwatch, {
        hsl: hsl,
        offset: '.80',
...
var Slider = function Slider(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.swatches },
      React__default["default"].createElement(SliderSwatches, { hsl: hsl, onClick: onChange })
    )
  );
};
...
var SwatchesColor = function SwatchesColor(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement(
      'div',
      { style: styles.check },
      React__default["default"].createElement(CheckIcon$1, null)
    )
  );
};
...
var SwatchesGroup = function SwatchesGroup(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    map(group, function (color, i) {
      return React__default["default"].createElement(SwatchesColor, {
        key: color,
        color: color,
      ...
      React__default["default"].createElement(
        ...
        React__default["default"].createElement(
          ...
          map(colors, function (group) {
            return React__default["default"].createElement(SwatchesGroup, {
              key: group.toString(),
              group: group,
              active: hex,
              onClick: handleChange,
...
Swatches.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  height: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  colors: T__default["default"].arrayOf(T__default["default"].arrayOf(T__default["default"].string)),
  styles: T__default["default"].object
...
Twitter.propTypes = {
  width: T__default["default"].oneOfType([T__default["default"].string, T__default["default"].number]),
  triangle: T__default["default"].oneOf(['hide', 'top-left', 'top-right']),
  colors: T__default["default"].arrayOf(T__default["default"].string),
  styles: T__default["default"].object
};
...
GooglePointerCircle.propTypes = {
  hsl: T__default["default"].shape({
    h: T__default["default"].number,
    s: T__default["default"].number,
    l: T__default["default"].number,
    a: T__default["default"].number
  })
};
...
var Google = function Google(_ref) {
  ...
  return React__default["default"].createElement(
    ...
    React__default["default"].createElement('div', { style: styles.swatch }),
    React__default["default"].createElement(
      'div',
      { style: styles.saturation },
      React__default["default"].createElement(Saturation, {
    ...
    React__default["default"].createElement(
      ...
      React__default["default"].createElement(GoogleFields, {
        rgb: rgb,
        hsl: hsl,
        hex: hex,
        hsv: hsv,
...
var style = {"header":"ethereans-interfaces_color-field_header","inputContainer":"ethereans-interfaces_color-field_inputContainer","picker":"ethereans-interfaces_color-field_picker","innerPicker":"ethereans-interfaces_color-field_innerPicker","pickerComponent":"ethereans-interfaces_color-field_pickerComponent","tooltip":"ethereans-interfaces_color-field_tooltip"};
...
function OutsideManager(props) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ref: wrapperRef,
    className: style.pickerComponent
  }, props.children);
}

OutsideManager.propTypes = {
  onClickOutside: T__default["default"].func,
  children: T__default["default"].oneOfType([T__default["default"].arrayOf(T__default["default"].node), T__default["default"].node])
};
...
var ColorField = function ColorField(_ref) {
  ...
  var handleChangeColor = React.useCallback(function (color, event) {
    helpers.setValue(color.hex);
    event.stopPropagation();
    event.preventDefault();
  }, [helpers]);
  var handleChangeComplete = React.useCallback(function (color, event) {
    helpers.setValue(color.hex);
    event.stopPropagation();
    event.preventDefault();
  }, [helpers]);
  ...
  }, "\xA0"), showPicker && /*#__PURE__*/React__default["default"].createElement(OutsideManager, {
    onClickOutside: handleClickOutside
  }, /*#__PURE__*/React__default["default"].createElement(SketchPicker, {
    color: field.value || '#000',
    onChangeComplete: handleChangeComplete,
    onChange: handleChangeColor
  })))), description && /*#__PURE__*/React__default["default"].createElement(ToolTip, {
...
ColorField.propTypes = {
  label: T__default["default"].string,
  description: T__default["default"].string,
  tabIndex: T__default["default"].number,
  id: T__default["default"].string.isRequired,
  name: T__default["default"].string
};
